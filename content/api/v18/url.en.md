...
<Metadata version="v18.14.2" data={{"source_link":"lib/url.js"}} />
...
* [`URLSearchParams`](/api/v18/url#urlsearchparams)
...
* `blob` [`Blob`](/api/v18/buffer#blob)
* Returns: [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type)

Creates a `'blob:nodedata:...'` URL string that represents the given [`Blob`](/api/v18/buffer#blob)
...
The data stored by the registered [`Blob`](/api/v18/buffer#blob) will be retained in memory until
...
Removes the stored [`Blob`](/api/v18/buffer#blob) identified by the given ID. Attempting to revoke a
...
* `url` [`URL`](/api/v18/url#the-whatwg-url-api) | [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) The file URL string or URL object to convert to a path.
...
* `URL` [`URL`](/api/v18/url#the-whatwg-url-api) A [WHATWG URL][] object
...
* Returns: [`URL`](/api/v18/url#the-whatwg-url-api) The file URL object.
...
* `url` [`URL`](/api/v18/url#the-whatwg-url-api) The [WHATWG URL][] object to convert to an options object.
