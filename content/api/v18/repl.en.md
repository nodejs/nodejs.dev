...
<Metadata version="v18.16.1" data={{"source_link":"lib/repl.js"}} />
...
* Extends: [`readline.Interface`](/api/v18/readline#readlineinterface)
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) called when history writes are ready or upon error
  ...
  * `repl` [`repl.REPLServer`](/api/v18/repl#replserver)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type)
  ...
  * `input` [`stream.Readable`](/api/v18/stream#streamreadable) The `Readable` stream from which REPL input will
    be read. **Default:** `process.stdin`.
  * `output` [`stream.Writable`](/api/v18/stream#streamwritable) The `Writable` stream to which REPL output will
...
* Returns: [`repl.REPLServer`](/api/v18/repl#replserver)
