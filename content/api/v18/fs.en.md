...
<Metadata version="v18.14.2" data={{"source_link":"lib/fs.js"}} />
...
<Metadata data={{"changes":[{"version":"v17.6.0","pr-url":"https://github.com/nodejs/node/pull/41819","description":"Accepts an additional `verbatimSymlinks` option to specify whether to perform path resolution for symlinks."}],"update":{"type":"added","version":["v16.7.0"]}}} />
