...
<Metadata version="v18.12.0" data={{"source_link":"lib/zlib.js"}} />
...
<Metadata version="v18.12.0" data={{"update":{"type":"added","version":["v11.7.0","v10.16.0"]}}} />
...
<Metadata version="v18.12.0" data={{"changes":[{"version":["v14.5.0","v12.19.0"],"pr-url":"https://github.com/nodejs/node/pull/33516","description":"The `maxOutputLength` option is supported now."}],"update":{"type":"added","version":["v11.7.0"]}}} />
...
<Metadata version="v18.12.0" data={{"changes":[{"version":"v5.0.0","pr-url":"https://github.com/nodejs/node/pull/2595","description":"A truncated input stream will now result in an `'error'` event."}],"update":{"type":"added","version":["v0.5.8"]}}} />

Decompress a deflate stream.

### <DataTag tag="C" /> `zlib.InflateRaw`

<Metadata version="v18.12.0" data={{"changes":[{"version":"v6.8.0","pr-url":"https://github.com/nodejs/node/pull/8512","description":"Custom dictionaries are now supported by `InflateRaw`."},{"version":"v5.0.0","pr-url":"https://github.com/nodejs/node/pull/2595","description":"A truncated input stream will now result in an `'error'` event."}],"update":{"type":"added","version":["v0.5.8"]}}} />
...
<Metadata version="v18.12.0" data={{"changes":[{"version":["v11.7.0","v10.16.0"],"pr-url":"https://github.com/nodejs/node/pull/24939","description":"This class was renamed from `Zlib` to `ZlibBase`."}],"update":{"type":"added","version":["v0.5.8"]}}} />
...
<Metadata version="v18.12.0" data={{"stability":{"level":0,"text":" - Deprecated: Use `zlib.bytesWritten` instead."}}} />
...
<Metadata version="v18.12.0" data={{"update":{"type":"added","version":["v7.0.0"]}}} />
...
### <DataTag tag="M" /> `zlib.createGunzip([options])`
