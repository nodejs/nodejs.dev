...
<Metadata data={{"update":{"type":"introduced_in","version":["v8.1.0"]}}} />
...
<Metadata version="v18.14.1" data={{"source_link":"lib/async_hooks.js"}} />
...
* Returns: [`AsyncHook`](/api/v18/async_hooks#async_hookscreatehookcallbacks) Instance used for disabling and enabling hooks
...
* Returns: [`AsyncHook`](/api/v18/async_hooks#async_hookscreatehookcallbacks) A reference to `asyncHook`.
...
<Metadata data={{"changes":[{"version":"v8.2.0","pr-url":"https://github.com/nodejs/node/pull/13490","description":"Renamed from `currentId`."}],"update":{"type":"added","version":["v8.1.0"]}}} />
