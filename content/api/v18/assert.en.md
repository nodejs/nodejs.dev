...
<Metadata version="v18.10.0" data={{"update":{"type":"introduced_in","version":["v0.1.21"]}}} />

<Metadata version="v18.10.0" data={{"stability":{"level":2,"text":" - Stable"}}} />

<Metadata version="v18.10.0" data={{"source_link":"lib/assert.js"}} />
...
<Metadata version="v18.10.0" data={{"update":{"type":"added","version":["v14.2.0","v12.19.0"]}}} />
...
<Metadata version="v18.10.0" data={{"stability":{"level":3,"text":" - Legacy: Use `assert.deepStrictEqual()` instead."}}} />
...
<Metadata version="v18.10.0" data={{"changes":[{"version":"v16.0.0","pr-url":"https://github.com/nodejs/node/pull/38111","description":"This API is no longer experimental."}],"update":{"type":"added","version":["v13.6.0","v12.16.0"]}}} />
...
<Metadata version="v18.10.0" data={{"stability":{"level":3,"text":" - Legacy: Use `assert.strictEqual()` instead."}}} />
...
<Metadata version="v18.10.0" data={{"changes":[{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/18418","description":"Calling `assert.fail()` with more than one argument is deprecated and emits a warning."}],"update":{"type":"added","version":["v0.1.21"]}}} />

<Metadata version="v18.10.0" data={{"stability":{"level":0,"text":" - Deprecated: Use `assert.fail([message])` or other assert functions instead."}}} />
...
<Metadata version="v18.10.0" data={{"stability":{"level":3,"text":" - Legacy: Use `assert.notDeepStrictEqual()` instead."}}} />
...
<Metadata version="v18.10.0" data={{"stability":{"level":3,"text":" - Legacy: Use `assert.notStrictEqual()` instead."}}} />
...
<Metadata version="v18.10.0" data={{"changes":[{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/17003","description":"Used comparison changed from Strict Equality to `Object.is()`."}],"update":{"type":"added","version":["v0.1.21"]}}} />
...
<Metadata version="v18.10.0" data={{"changes":[{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/18319","description":"The `assert.ok()` (no arguments) will now use a predefined error message."}],"update":{"type":"added","version":["v0.1.21"]}}} />
