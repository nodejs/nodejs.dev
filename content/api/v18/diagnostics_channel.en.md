...
category: 'api'
editPage: 'https://github.com/nodejs/node/blob/v18.8.0/doc/api/diagnostics_channel.md'
version: 'v18'
---

<Metadata version="v18.8.0" data={{"update":{"type":"introduced_in","version":["v15.1.0"]}}} />

<Metadata version="v18.8.0" data={{"stability":{"level":1,"text":" - Experimental"}}} />

<Metadata version="v18.8.0" data={{"source_link":"lib/diagnostics_channel.js"}} />
...
<Metadata version="v18.8.0" data={{"update":{"type":"deprecated","version":["v18.7.0"]}}} />

<Metadata version="v18.8.0" data={{"stability":{"level":0,"text":" - Deprecated: Use [`diagnostics_channel.subscribe(name, onMessage)`][]"}}} />
...
<Metadata version="v18.8.0" data={{"changes":[{"version":["v17.1.0","v16.14.0","v14.19.0"],"pr-url":"https://github.com/nodejs/node/pull/40433","description":"Added return value. Added to channels without subscribers."}],"update":{"type":"deprecated","version":["v18.7.0"]}}} />

<Metadata version="v18.8.0" data={{"stability":{"level":0,"text":" - Deprecated: Use [`diagnostics_channel.unsubscribe(name, onMessage)`][]"}}} />
