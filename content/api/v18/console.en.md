...
<Metadata version="v18.13.0" data={{"update":{"type":"introduced_in","version":["v0.10.13"]}}} />

<Metadata version="v18.13.0" data={{"stability":{"level":2,"text":" - Stable"}}} />

<Metadata version="v18.13.0" data={{"source_link":"lib/console.js"}} />
...
<Metadata version="v18.13.0" data={{"changes":[{"version":"v8.0.0","pr-url":"https://github.com/nodejs/node/pull/9744","description":"Errors that occur while writing to the underlying streams will now be ignored by default."}]}} />
...
<Metadata version="v18.13.0" data={{"changes":[{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/17706","description":"The implementation is now spec compliant and does not throw anymore."}],"update":{"type":"added","version":["v0.1.101"]}}} />
...
<Metadata version="v18.13.0" data={{"changes":[{"version":"v8.10.0","pr-url":"https://github.com/nodejs/node/pull/17033","description":"`console.debug` is now an alias for `console.log`."}],"update":{"type":"added","version":["v8.0.0"]}}} />
...
<Metadata version="v18.13.0" data={{"changes":[{"version":"v9.3.0","pr-url":"https://github.com/nodejs/node/pull/17152","description":"`console.dirxml` now calls `console.log` for its arguments."}],"update":{"type":"added","version":["v8.0.0"]}}} />
...
<Metadata version="v18.13.0" data={{"update":{"type":"added","version":["v0.1.104"]}}} />
