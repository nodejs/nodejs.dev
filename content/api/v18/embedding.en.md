...
<MC data={{"update":{"type":"introduced_in","version":["v12.19.0"]}}} />
...
<MC data={{"changes":[{"version":"v15.0.0","pr-url":"https://github.com/nodejs/node/pull/35597","description":"The `CommonEnvironmentSetup` and `SpinEventLoop` utilities were added."}]}} />
...
[CLI options]: (/api/cli)
[`process.memoryUsage()`]: (/api/process#processmemoryusage)
[deprecation policy]: (/api/deprecations)
