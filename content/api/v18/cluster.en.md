...
<Metadata version="v18.16.1" data={{"source_link":"lib/cluster.js"}} />
...
* Returns: [`cluster.Worker`](/api/v18/cluster#worker) A reference to `worker`.
...
* [`ChildProcess`](/api/v18/child_process#childprocess)
...
* `worker` [`cluster.Worker`](/api/v18/cluster#worker)
...
* Returns: [`cluster.Worker`](/api/v18/cluster#worker)
