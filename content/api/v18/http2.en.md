...
<Metadata version="v18.14.0" data={{"update":{"type":"added","version":["v10.1.0"]}}} />
...
<Metadata version="v18.14.0" data={{"changes":[{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/18780","description":"This method now returns a reference to `ServerResponse`."}],"update":{"type":"added","version":["v8.4.0"]}}} />
...
<Metadata version="v18.14.0" data={{"changes":[{"version":["v11.10.0","v10.17.0"],"pr-url":"https://github.com/nodejs/node/pull/25974","description":"Return `this` from `writeHead()` to allow chaining with `end()`."}],"update":{"type":"added","version":["v8.4.0"]}}} />
