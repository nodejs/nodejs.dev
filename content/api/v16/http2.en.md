...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v8.9.3"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v15.3.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v9.5.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v8.5.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":["v14.5.0","v12.19.0"],"pr-url":"https://github.com/nodejs/node/pull/33160","description":"Allow explicitly setting date headers."}],"update":{"type":"added","version":["v8.4.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":"v13.0.0","pr-url":"https://github.com/nodejs/node/pull/27558","description":"The default timeout changed from 120s to 0 (no timeout)."}],"update":{"type":"added","version":["v8.4.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v10.1.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/18780","description":"This method now returns a reference to `ServerResponse`."}],"update":{"type":"added","version":["v8.4.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":["v11.10.0","v10.17.0"],"pr-url":"https://github.com/nodejs/node/pull/25974","description":"Return `this` from `writeHead()` to allow chaining with `end()`."}],"update":{"type":"added","version":["v8.4.0"]}}} />
...
[`net.Socket.bufferSize`]: /api/v16/net#socketbuffersize
[`net.Socket.prototype.ref()`]: /api/v16/net#socketref
[`net.Socket.prototype.unref()`]: /api/v16/net#socketunref
[`net.Socket`]: /api/v16/net#class-netsocket
[`net.connect()`]: /api/v16/net#netconnect
[`net.createServer()`]: /api/v16/net#netcreateserveroptions-connectionlistener
[`request.authority`]: #requestauthority
[`request.maxHeadersCount`]: /api/v16/http#requestmaxheaderscount
...
[`response.write(data, encoding)`]: /api/v16/http#responsewritechunk-encoding-callback
[`response.writeContinue()`]: #responsewritecontinue
[`response.writeHead()`]: #responsewriteheadstatuscode-statusmessage-headers
[`server.maxHeadersCount`]: /api/v16/http#servermaxheaderscount
[`tls.Server.close()`]: /api/v16/tls#serverclosecallback
[`tls.TLSSocket`]: /api/v16/tls#class-tlstlssocket
[`tls.connect()`]: /api/v16/tls#tlsconnectoptions-callback
[`tls.createServer()`]: /api/v16/tls#tlscreateserveroptions-secureconnectionlistener
[`writable.writableFinished`]: /api/v16/stream#writablewritablefinished
