...
* `line` [`Buffer`](/api/v16/buffer#buffer) Line of ASCII text, in NSS `SSLKEYLOGFILE` format.
* `tlsSocket` [`tls.TLSSocket`](/api/v16/tls#tlstlssocket) The `tls.TLSSocket` instance on which it was
  generated.
...
* `sessionId` [`Buffer`](/api/v16/buffer#buffer) The TLS session identifier
* `sessionData` [`Buffer`](/api/v16/buffer#buffer) The TLS session data
...
* `certificate` [`Buffer`](/api/v16/buffer#buffer) The server certificate
* `issuer` [`Buffer`](/api/v16/buffer#buffer) The issuer's certificate
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) A callback function to be called when the prior session
  ...
  * `sessionData` [`Buffer`](/api/v16/buffer#buffer)
...
* `tlsSocket` [`tls.TLSSocket`](/api/v16/tls#tlstlssocket) The established TLS socket.
...
* `tlsSocket` [`tls.TLSSocket`](/api/v16/tls#tlstlssocket) The `tls.TLSSocket` instance from which the
  error originated.
...
* Returns: [`tls.Server`](/api/v16/tls#tlsserver)
...
* Returns: [`Buffer`](/api/v16/buffer#buffer) A 48-byte buffer containing the session ticket keys.
...
* `keys` [`Buffer`](/api/v16/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) A 48-byte buffer containing the session
  ticket keys.
...
* `socket` [`net.Socket`](/api/v16/net#netsocket) | [`stream.Duplex`](/api/v16/stream#streamduplex)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `server` [`net.Server`](/api/v16/net#netserver) A [`net.Server`][] instance.
  ...
  * `session` [`Buffer`](/api/v16/buffer#buffer) A `Buffer` instance containing a TLS session.
...
* `response` [`Buffer`](/api/v16/buffer#buffer) The server's OCSP response
...
The `'secureConnect'` event is not emitted when a [`tls.TLSSocket`](/api/v16/tls#tlstlssocket) is created
...
* `session` [`Buffer`](/api/v16/buffer#buffer)
...
* `context` [`Buffer`](/api/v16/buffer#buffer) Optionally provide a context.

* Returns: [`Buffer`](/api/v16/buffer#buffer) requested bytes of the keying material
...
* Returns: [`Buffer`](/api/v16/buffer#buffer) | [`undefined`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Undefined_type) The latest `Finished` message that has been
...
<Metadata data={{"changes":[{"version":"v16.14.0","pr-url":"https://github.com/nodejs/node/pull/39809","description":"Add fingerprint512."},{"version":"v11.4.0","pr-url":"https://github.com/nodejs/node/pull/24358","description":"Support Elliptic Curve public key info."}]}} />

A certificate object has properties corresponding to the fields of the
certificate.

* `raw` [`Buffer`](/api/v16/buffer#buffer) The DER encoded X.509 certificate data.
...
* `modulus` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) The RSA modulus, as a hexadecimal string. Example:
  `'B56CE45CB7...'`.
* `pubkey` [`Buffer`](/api/v16/buffer#buffer) The public key.
...
* Returns: [`Buffer`](/api/v16/buffer#buffer) | [`undefined`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Undefined_type) The latest `Finished` message that is expected
...
* Returns: [`X509Certificate`](/api/v16/crypto#x509certificate)

Returns the peer certificate as an [`X509Certificate`](/api/v16/crypto#x509certificate) object.
...
Returns the local certificate as an [`X509Certificate`](/api/v16/crypto#x509certificate) object.
...
<Metadata data={{"changes":[{"version":"v16.13.2","pr-url":"https://github.com/nodejs-private/node-private/pull/300","description":"Support for `uniformResourceIdentifier` subject alternative names has been disabled in response to CVE-2021-44531."}],"update":{"type":"added","version":["v0.8.4"]}}} />
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `socket` [`stream.Duplex`](/api/v16/stream#streamduplex) Establish secure connection on a given socket
  ...
  * `ALPNProtocols`: [`Buffer`](/api/v16/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView)
  ...
  * `session` [`Buffer`](/api/v16/buffer#buffer) A `Buffer` instance, containing TLS session.
...
* Returns: [`tls.TLSSocket`](/api/v16/tls#tlstlssocket)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `ca` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v16/buffer#buffer) Optionally override the trusted CA
  ...
  * `cert` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v16/buffer#buffer) Cert chains in PEM format. One
  ...
  * `clientCertEngine` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) Name of an OpenSSL engine which can provide the
    client certificate.
  * `crl` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v16/buffer#buffer) PEM formatted CRLs (Certificate
    Revocation Lists).
  * `dhparam` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v16/buffer#buffer) Diffie-Hellman parameters, required for
  ...
  * `key` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v16/buffer#buffer) Private keys in PEM
  ...
  * `passphrase` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) Shared passphrase used for a single private key and/or
    a PFX.
  * `pfx` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v16/buffer#buffer) PFX or PKCS12 encoded
  ...
  * `ticketKeys`: [`Buffer`](/api/v16/buffer#buffer) 48-bytes of cryptographically strong pseudorandom
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `pskCallback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    ...
    * socket: [`tls.TLSSocket`](/api/v16/tls#tlstlssocket) the server [`tls.TLSSocket`][] instance for
      this connection.
    ...
    * Returns: [`Buffer`](/api/v16/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) pre-shared key that must either be
