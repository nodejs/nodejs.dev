...
<Metadata data={{"changes":[{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/43310","description":"Removed proprietary `'node.keyObject'` import/export format."},{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/43310","description":"Removed proprietary `'NODE-DSA'`, `'NODE-DH'`, and `'NODE-SCRYPT'` algorithms."},{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/42507","description":"Added `'Ed25519'`, `'Ed448'`, `'X25519'`, and `'X448'` algorithms."},{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/42507","description":"Removed proprietary `'NODE-ED25519'` and `'NODE-ED448'` algorithms."},{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/42507","description":"Removed proprietary `'NODE-X25519'` and `'NODE-X448'` named curves from the `'ECDH'` algorithm."}]}} />
...
The [`SubtleCrypto`](/api/v16/webcrypto#subtlecrypto) class can be used to generate symmetric (secret) keys
...
* Type: [`SubtleCrypto`](/api/v16/webcrypto#subtlecrypto)
...
* `typedArray` [`Buffer`](/api/v16/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray)
* Returns: [`Buffer`](/api/v16/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray)
...
* Type: [`AesKeyGenParams`](/api/v16/webcrypto#aeskeygenparams) | [`RsaHashedKeyGenParams`](/api/v16/webcrypto#rsahashedkeygenparams) | [`EcKeyGenParams`](/api/v16/webcrypto#eckeygenparams) | [`HmacKeyGenParams`](/api/v16/webcrypto#hmackeygenparams)
...
When `true`, the [`CryptoKey`](/api/v16/webcrypto#cryptokey) can be extracted using either
...
* Type: [`CryptoKey`](/api/v16/webcrypto#cryptokey) A [`CryptoKey`](/api/v16/webcrypto#cryptokey) whose `type` will be `'private'`.

#### <DataTag tag="M" /> `cryptoKeyPair.publicKey`

<Metadata data={{"update":{"type":"added","version":["v15.0.0"]}}} />

* Type: [`CryptoKey`](/api/v16/webcrypto#cryptokey) A [`CryptoKey`](/api/v16/webcrypto#cryptokey) whose `type` will be `'public'`.
...
* `algorithm`: [`RsaOaepParams`](/api/v16/webcrypto#rsaoaepparams) | [`AesCtrParams`](/api/v16/webcrypto#aesctrparams) | [`AesCbcParams`](/api/v16/webcrypto#aescbcparams) | [`AesGcmParams`](/api/v16/webcrypto#aesgcmparams)
* `key`: [`CryptoKey`](/api/v16/webcrypto#cryptokey)
* `data`: [`ArrayBuffer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) | [`Buffer`](/api/v16/buffer#buffer)
...
<Metadata data={{"changes":[{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/42507","description":"Added `'X25519'`, and `'X448'` algorithms."}],"update":{"type":"added","version":["v15.0.0"]}}} />

* `algorithm`: [`AlgorithmIdentifier`](/api/v16/webcrypto#algorithmidentifier) | [`EcdhKeyDeriveParams`](/api/v16/webcrypto#ecdhkeyderiveparams) | [`HkdfParams`](/api/v16/webcrypto#hkdfparams) | [`Pbkdf2Params`](/api/v16/webcrypto#pbkdf2params)
* `baseKey`: [`CryptoKey`](/api/v16/webcrypto#cryptokey)
...
* `algorithm`: [`AlgorithmIdentifier`](/api/v16/webcrypto#algorithmidentifier) | [`EcdhKeyDeriveParams`](/api/v16/webcrypto#ecdhkeyderiveparams) | [`HkdfParams`](/api/v16/webcrypto#hkdfparams) | [`Pbkdf2Params`](/api/v16/webcrypto#pbkdf2params)
* `baseKey`: [`CryptoKey`](/api/v16/webcrypto#cryptokey)
* `derivedKeyAlgorithm`: [`HmacKeyGenParams`](/api/v16/webcrypto#hmackeygenparams) | [`AesKeyGenParams`](/api/v16/webcrypto#aeskeygenparams)
* `extractable`: [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type)
* `keyUsages`: string\[] See [Key usages][].
* Returns: [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) containing [`CryptoKey`](/api/v16/webcrypto#cryptokey)

Using the method and parameters specified in `algorithm`, and the keying
material provided by `baseKey`, `subtle.deriveKey()` attempts to generate
a new [`CryptoKey`](/api/v16/webcrypto#cryptokey) based on the method and parameters in `derivedKeyAlgorithm`.
...
<Metadata data={{"changes":[{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/42507","description":"Added `'Ed25519'`, `'Ed448'`, `'X25519'`, and `'X448'` algorithms."},{"version":"v15.9.0","pr-url":"https://github.com/nodejs/node/pull/37203","description":"Removed `'NODE-DSA'` JWK export."}],"update":{"type":"added","version":["v15.0.0"]}}} />
...
If the [`CryptoKey`](/api/v16/webcrypto#cryptokey) is not extractable, the returned promise will reject.
...
* `algorithm`: [`AlgorithmIdentifier`](/api/v16/webcrypto#algorithmidentifier) | [`RsaHashedKeyGenParams`](/api/v16/webcrypto#rsahashedkeygenparams) | [`EcKeyGenParams`](/api/v16/webcrypto#eckeygenparams) | [`HmacKeyGenParams`](/api/v16/webcrypto#hmackeygenparams) | [`AesKeyGenParams`](/api/v16/webcrypto#aeskeygenparams)

* `extractable`: [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type)
* `keyUsages`: string\[] See [Key usages][].
* Returns: [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) containing [`CryptoKey`](/api/v16/webcrypto#cryptokey) | [`CryptoKeyPair`](/api/v16/webcrypto#cryptokeypair)

Using the method and parameters provided in `algorithm`, `subtle.generateKey()`
attempts to generate new keying material. Depending the method used, the method
may generate either a single [`CryptoKey`](/api/v16/webcrypto#cryptokey) or a [`CryptoKeyPair`](/api/v16/webcrypto#cryptokeypair).

The [`CryptoKeyPair`](/api/v16/webcrypto#cryptokeypair) (public and private key) generating algorithms supported
include:
...
The [`CryptoKey`](/api/v16/webcrypto#cryptokey) (secret key) generating algorithms supported include:
...
<Metadata data={{"changes":[{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/42507","description":"Added `'Ed25519'`, `'Ed448'`, `'X25519'`, and `'X448'` algorithms."},{"version":"v15.9.0","pr-url":"https://github.com/nodejs/node/pull/37203","description":"Removed `'NODE-DSA'` JWK import."}],"update":{"type":"added","version":["v15.0.0"]}}} />

* `format`: [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) Must be one of `'raw'`, `'pkcs8'`, `'spki'`, or `'jwk'`.
* `keyData`: [`ArrayBuffer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) | [`Buffer`](/api/v16/buffer#buffer) | [`KeyObject`](/api/v16/crypto#keyobject)

* `algorithm`: [`AlgorithmIdentifier`](/api/v16/webcrypto#algorithmidentifier) | [`RsaHashedImportParams`](/api/v16/webcrypto#rsahashedimportparams) | [`EcKeyImportParams`](/api/v16/webcrypto#eckeyimportparams) | [`HmacImportParams`](/api/v16/webcrypto#hmacimportparams)
...
as the given `format` to create a [`CryptoKey`](/api/v16/webcrypto#cryptokey) instance using the provided
`algorithm`, `extractable`, and `keyUsages` arguments. If the import is
successful, the returned promise will be resolved with the created [`CryptoKey`](/api/v16/webcrypto#cryptokey).
...
<Metadata data={{"changes":[{"version":"v16.17.0","pr-url":"https://github.com/nodejs/node/pull/42507","description":"Added `'Ed25519'`, and `'Ed448'` algorithms."}],"update":{"type":"added","version":["v15.0.0"]}}} />

* `algorithm`: [`AlgorithmIdentifier`](/api/v16/webcrypto#algorithmidentifier) | [`RsaPssParams`](/api/v16/webcrypto#rsapssparams) | [`EcdsaParams`](/api/v16/webcrypto#ecdsaparams) | [`Ed448Params`](/api/v16/webcrypto#ed448params)
* `key`: [`CryptoKey`](/api/v16/webcrypto#cryptokey)
* `data`: [`ArrayBuffer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) | [`Buffer`](/api/v16/buffer#buffer)
* Returns: [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) containing [`ArrayBuffer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)
...
* `unwrappingKey`: [`CryptoKey`](/api/v16/webcrypto#cryptokey)

* `unwrapAlgo`: [`AlgorithmIdentifier`](/api/v16/webcrypto#algorithmidentifier) | [`RsaOaepParams`](/api/v16/webcrypto#rsaoaepparams) | [`AesCtrParams`](/api/v16/webcrypto#aesctrparams) | [`AesCbcParams`](/api/v16/webcrypto#aescbcparams) | [`AesGcmParams`](/api/v16/webcrypto#aesgcmparams)
* `unwrappedKeyAlgo`: [`AlgorithmIdentifier`](/api/v16/webcrypto#algorithmidentifier) | [`RsaHashedImportParams`](/api/v16/webcrypto#rsahashedimportparams) | [`EcKeyImportParams`](/api/v16/webcrypto#eckeyimportparams) | [`HmacImportParams`](/api/v16/webcrypto#hmacimportparams)
...
key and create a [`CryptoKey`](/api/v16/webcrypto#cryptokey) instance. It is equivalent to calling
...
promise is resolved with a [`CryptoKey`](/api/v16/webcrypto#cryptokey) object.
...
* `format`: [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) Must be one of `'raw'`, `'pkcs8'`, `'spki'`, or `'jwk'`.
* `key`: [`CryptoKey`](/api/v16/webcrypto#cryptokey)
* `wrappingKey`: [`CryptoKey`](/api/v16/webcrypto#cryptokey)
* `wrapAlgo`: [`AlgorithmIdentifier`](/api/v16/webcrypto#algorithmidentifier) | [`RsaOaepParams`](/api/v16/webcrypto#rsaoaepparams) | [`AesCtrParams`](/api/v16/webcrypto#aesctrparams) | [`AesCbcParams`](/api/v16/webcrypto#aescbcparams) | [`AesGcmParams`](/api/v16/webcrypto#aesgcmparams)
* Returns: [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) containing [`ArrayBuffer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)
...
the various [`SubtleCrypto`](/api/v16/webcrypto#subtlecrypto) methods. While described here as "classes", they
...
* Type: [`ArrayBuffer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) | [`Buffer`](/api/v16/buffer#buffer) | [`undefined`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Undefined_type)
...
* Type: [`CryptoKey`](/api/v16/webcrypto#cryptokey)
