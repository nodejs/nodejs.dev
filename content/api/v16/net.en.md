...
<Metadata version="v16.19.0" data={{"update":{"type":"added","version":["v0.9.7"]}}} />
...
<Metadata version="v16.19.0" data={{"changes":[{"version":"v15.6.0","pr-url":"https://github.com/nodejs/node/pull/36623","description":"AbortSignal support was added."},{"version":"v11.4.0","pr-url":"https://github.com/nodejs/node/pull/23798","description":"The `ipv6Only` option is supported."}],"update":{"type":"added","version":["v0.11.14"]}}} />
...
<Metadata version="v16.19.0" data={{"update":{"type":"added","version":["v0.2.0"]}}} />
...
<Metadata version="v16.19.0" data={{"changes":[{"version":"v15.14.0","pr-url":"https://github.com/nodejs/node/pull/37735","description":"AbortSignal support was added."}],"update":{"type":"added","version":["v0.3.4"]}}} />
...
<Metadata version="v16.19.0" data={{"changes":[{"version":"v5.10.0","pr-url":"https://github.com/nodejs/node/pull/5598","description":"The `host` parameter is supported now."}],"update":{"type":"added","version":["v0.11.3"]}}} />
...
<Metadata version="v16.19.0" data={{"update":{"type":"deprecated","version":["v14.6.0"]}}} />

<Metadata version="v16.19.0" data={{"stability":{"level":0,"text":" - Deprecated: Use [`writable.writableLength`][] instead."}}} />
...
<Metadata version="v16.19.0" data={{"update":{"type":"added","version":["v0.9.6"]}}} />
...
<Metadata version="v16.19.0" data={{"changes":[{"version":["v13.12.0","v12.17.0"],"pr-url":"https://github.com/nodejs/node/pull/32204","description":"New defaults for `TCP_KEEPCNT` and `TCP_KEEPINTVL` socket options were added."}],"update":{"type":"added","version":["v0.1.92"]}}} />
...
<Metadata version="v16.19.0" data={{"changes":[{"version":["v17.7.0","v16.15.0"],"pr-url":"https://github.com/nodejs/node/pull/41310","description":"The `noDelay`, `keepAlive`, and `keepAliveInitialDelay` options are supported now."}],"update":{"type":"added","version":["v0.5.0"]}}} />
