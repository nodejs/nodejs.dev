...
<Metadata version="v16.18.0" data={{"update":{"type":"introduced_in","version":["v4.0.0"]}}} />
...
<Metadata version="v16.18.0" data={{"type":"class"}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v16.9.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":"11.12.0","pr-url":"https://github.com/nodejs/node/pull/26487","description":"The error message was removed."},{"version":"v16.2.0","pr-url":"https://github.com/nodejs/node/pull/38510","description":"The error message was reintroduced."}],"update":{"type":"added","version":["v16.2.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v12.5.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v14.0.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v15.14.0"]}}} />
...
#### <DataTag tag="M" /> `ERR_INVALID_CALLBACK`
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v13.3.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v13.10.0","v12.17.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":["v11.4.0","v10.15.0"],"commit":"186035243fad247e3955f","pr-url":"https://github.com/nodejs-private/node-private/pull/143","description":"Max header size in `http_parser` was set to 8 KiB."}]}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":"v12.0.0","pr-url":"https://github.com/nodejs/node/pull/25690","description":"Added `requireStack` property."}]}} />
...
<Metadata version="v16.18.0" data={{"stability":{"level":0,"text":" - Deprecated. These error codes are either inconsistent, or have been removed."}}} />

<a id="ERR_CANNOT_TRANSFER_OBJECT"></a>

#### <DataTag tag="M" /> `ERR_CANNOT_TRANSFER_OBJECT`

<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v12.5.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v12.12.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v10.0.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v11.0.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v15.0.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v14.0.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":"v10.12.0","pr-url":"https://github.com/nodejs/node/pull/23053","description":"Rather than emitting an error, `process.stderr.end()` now only closes the stream side but not the underlying resource, making this error obsolete."}],"update":{"type":"removed","version":["v10.12.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v11.7.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v16.17.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"removed","version":["v16.9.0"]}}} />
...
[ES Module]: /api/v16/esm
[ICU]: /api/v16/intl#internationalization-support
...
[WHATWG Supported Encodings]: /api/v16/util#whatwg-supported-encodings
[WHATWG URL API]: /api/v16/url#the-whatwg-url-api
[`"exports"`]: /api/v16/packages#exports
[`"imports"`]: /api/v16/packages#imports
[`'uncaughtException'`]: /api/v16/process#event-uncaughtexception
[`--disable-proto=throw`]: /api/v16/cli#--disable-protomode
[`--force-fips`]: /api/v16/cli#--force-fips
[`--no-addons`]: /api/v16/cli#--no-addons
[`Class: assert.AssertionError`]: /api/v16/assert#class-assertassertionerror
...
[`REPL`]: /api/v16/repl
[`Writable`]: /api/v16/stream#class-streamwritable
[`child_process`]: child_process.md
[`cipher.getAuthTag()`]: /api/v16/crypto#ciphergetauthtag
[`crypto.getDiffieHellman()`]: /api/v16/crypto#cryptogetdiffiehellmangroupname
[`crypto.scrypt()`]: /api/v16/crypto#cryptoscryptpassword-salt-keylen-options-callback
[`crypto.scryptSync()`]: /api/v16/crypto#cryptoscryptsyncpassword-salt-keylen-options
[`crypto.timingSafeEqual()`]: /api/v16/crypto#cryptotimingsafeequala-b
[`dgram.connect()`]: /api/v16/dgram#socketconnectport-address-callback
[`dgram.createSocket()`]: /api/v16/dgram#dgramcreatesocketoptions-callback
[`dgram.disconnect()`]: /api/v16/dgram#socketdisconnect
[`dgram.remoteAddress()`]: /api/v16/dgram#socketremoteaddress
[`errno`(3) man page]: https://man7.org/linux/man-pages/man3/errno.3.html
[`fs.Dir`]: /api/v16/fs#class-fsdir
[`fs.cp()`]: /api/v16/fs#fscpsrc-dest-options-callback
[`fs.readFileSync`]: /api/v16/fs#fsreadfilesyncpath-options
[`fs.readdir`]: /api/v16/fs#fsreaddirpath-options-callback
[`fs.symlink()`]: /api/v16/fs#fssymlinktarget-path-type-callback
[`fs.symlinkSync()`]: /api/v16/fs#fssymlinksynctarget-path-type
[`fs.unlink`]: /api/v16/fs#fsunlinkpath-callback
[`fs`]: /api/v16/fs
[`hash.digest()`]: /api/v16/crypto#hashdigestencoding
[`hash.update()`]: /api/v16/crypto#hashupdatedata-inputencoding
[`http`]: /api/v16/http
[`https`]: /api/v16/https
[`libuv Error handling`]: https://docs.libuv.org/en/v1.x/errors.html
[`net`]: /api/v16/net
[`new URL(input)`]: /api/v16/url#new-urlinput-base
[`new URLSearchParams(iterable)`]: /api/v16/url#new-urlsearchparamsiterable
...
[`readable._read()`]: /api/v16/stream#readable_readsize
[`require('node:crypto').setEngine()`]: /api/v16/crypto#cryptosetengineengine-flags
[`require()`]: /api/v16/modules#requireid
[`server.close()`]: /api/v16/net#serverclosecallback
[`server.listen()`]: /api/v16/net#serverlisten
[`sign.sign()`]: /api/v16/crypto#signsignprivatekey-outputencoding
[`stream.pipe()`]: /api/v16/stream#readablepipedestination-options
[`stream.push()`]: /api/v16/stream#readablepushchunk-encoding
[`stream.unshift()`]: /api/v16/stream#readableunshiftchunk-encoding
[`stream.write()`]: /api/v16/stream#writablewritechunk-encoding-callback
...
[`util.getSystemErrorName(error.errno)`]: /api/v16/util#utilgetsystemerrornameerr
[`util.inspect()`]: /api/v16/util#utilinspectobject-options
[`util.parseArgs()`]: /api/v16/util#utilparseargsconfig
[`v8.startupSnapshot.setDeserializeMainFunction()`]: v8.md#v8startupsnapshotsetdeserializemainfunctioncallback-data
[`zlib`]: /api/v16/zlib
[crypto digest algorithm]: /api/v16/crypto#cryptogethashes
[debugger]: /api/v16/debugger
[define a custom subpath]: /api/v16/packages#subpath-exports
[domains]: /api/v16/domain
[event emitter-based]: /api/v16/events#class-eventemitter
[file descriptors]: https://en.wikipedia.org/wiki/File_descriptor
[policy]: /api/v16/permissions#policies
[self-reference a package using its name]: /api/v16/packages#self-referencing-a-package-using-its-name
[stream-based]: /api/v16/stream
