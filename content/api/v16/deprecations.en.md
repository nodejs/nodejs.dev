...
The `'gc'`, `'http2'`, and `'http'` [`PerformanceEntry`](/api/v16/perf_hooks#performanceentry) object types have
...
Move to [`Stream`](/api/v16/stream#stream) API instead, as the [`http.ClientRequest`][],
