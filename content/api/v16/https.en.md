...
<Metadata version="v16.18.0" data={{"source_link":"lib/https.js"}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":"v12.5.0","pr-url":"https://github.com/nodejs/node/pull/28209","description":"do not automatically set servername if the target host was specified using an IP address."}]}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v11.3.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":"v13.0.0","pr-url":"https://github.com/nodejs/node/pull/27558","description":"The default timeout changed from 120s to 0 (no timeout)."}],"update":{"type":"added","version":["v0.11.2"]}}} />
...
[`Session Resumption`]: /api/v16/tls#session-resumption
[`URL`]: /api/v16/url#the-whatwg-url-api
[`http.Agent(options)`]: /api/v16/http#new-agentoptions
[`http.Agent`]: /api/v16/http#class-httpagent
[`http.ClientRequest`]: /api/v16/http#class-httpclientrequest
[`http.Server`]: /api/v16/http#class-httpserver
[`http.createServer()`]: /api/v16/http#httpcreateserveroptions-requestlistener
...
[`server.close()`]: /api/v16/http#serverclosecallback
[`server.headersTimeout`]: /api/v16/http#serverheaderstimeout
[`server.keepAliveTimeout`]: /api/v16/http#serverkeepalivetimeout
[`server.listen()`]: /api/v16/net#serverlisten
[`server.maxHeadersCount`]: /api/v16/http#servermaxheaderscount
[`server.requestTimeout`]: /api/v16/http#serverrequesttimeout
[`server.setTimeout()`]: /api/v16/http#serversettimeoutmsecs-callback
[`server.timeout`]: /api/v16/http#servertimeout
