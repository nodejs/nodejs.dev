...
<Metadata version="v16.18.0" data={{"name":"dgram"}} />

<Metadata version="v16.18.0" data={{"source_link":"lib/dgram.js"}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v0.6.9"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v13.1.0","v12.16.0"]}}} />
...
<Metadata version="v16.18.0" data={{"changes":[{"version":"v0.9.1","commit":"332fea5ac1816e498030109c4211bca24a7fa667","description":"The method was changed to an asynchronous execution model. Legacy code would need to be changed to pass a callback function to the method call."}],"update":{"type":"added","version":["v0.1.99"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v8.7.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v8.6.0"]}}} />
...
<Metadata version="v16.18.0" data={{"update":{"type":"added","version":["v0.3.8"]}}} />
...
[`'close'`]: #event-close
[`ERR_SOCKET_BAD_PORT`]: /api/v16/errors#err_socket_bad_port
[`ERR_SOCKET_BUFFER_SIZE`]: /api/v16/errors#err_socket_buffer_size
[`ERR_SOCKET_DGRAM_IS_CONNECTED`]: /api/v16/errors#err_socket_dgram_is_connected
[`ERR_SOCKET_DGRAM_NOT_CONNECTED`]: /api/v16/errors#err_socket_dgram_not_connected
[`Error`]: /api/v16/errors#class-error
[`System Error`]: /api/v16/errors#class-systemerror
...
[byte length]: /api/v16/buffer#static-method-bufferbytelengthstring-encoding
