...
<Metadata version="v16.20.1" data={{"source_link":"lib/worker_threads.js"}} />
...
<Metadata data={{"changes":[{"version":"v16.15.0","pr-url":"https://github.com/nodejs/node/pull/41272","description":"No longer experimental."}],"update":{"type":"added","version":["v15.12.0","v14.18.0"]}}} />
...
* `port` [`MessagePort`](/api/v16/worker_threads#messageport) The message port to transfer.
...
* Returns: [`MessagePort`](/api/v16/worker_threads#messageport)
...
* [`null`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Null_type) | [`MessagePort`](/api/v16/worker_threads#messageport)
...
* `port` [`MessagePort`](/api/v16/worker_threads#messageport) | [`BroadcastChannel`](/api/v16/worker_threads#broadcastchannel-extends-eventtarget)
...
* `value` may not contain native (C++-backed) objects other than:
  * [`CryptoKey`](/api/v16/webcrypto#cryptokey)s,
  * [`FileHandle`](/api/v16/fs#filehandle)s,
  * [`Histogram`](/api/v16/perf_hooks#histogram)s,
  * [`KeyObject`](/api/v16/crypto#keyobject)s,
  * [`MessagePort`](/api/v16/worker_threads#messageport)s,
  * [`net.BlockList`](/api/v16/net#netblocklist)s,
  * [`net.SocketAddress`](/api/v16/net#netsocketaddress)es,
  * [`X509Certificate`](/api/v16/crypto#x509certificate)s.
...
* `filename` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`URL`](/api/v16/url#the-whatwg-url-api) The path to the Worker's main script or module. Must
...
<Metadata data={{"update":{"type":"added","version":["v15.1.0","v12.22.0"]}}} />
...
* [`stream.Readable`](/api/v16/stream#streamreadable)
...
* [`null`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Null_type) | [`stream.Writable`](/api/v16/stream#streamwritable)
...
`Worker`s utilize message passing via [`MessagePort`](/api/v16/worker_threads#messageport) to implement interactions
