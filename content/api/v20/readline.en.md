...
<Metadata version="v20.3.1" data={{"source_link":"lib/readline.js"}} />
...
* Extends: [`readline.InterfaceConstructor`](/api/v20/readline#interfaceconstructor)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal) Optionally allows the `question()` to be canceled
...
* `stream` [`stream.Writable`](/api/v20/stream#streamwritable) A [TTY][] stream.
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `input` [`stream.Readable`](/api/v20/stream#streamreadable) The [Readable][] stream to listen to. This option
    is _required_.
  * `output` [`stream.Writable`](/api/v20/stream#streamwritable) The [Writable][] stream to write readline data
    to.
  ...
  * `tabSize` [`integer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) The number of spaces a tab is equal to (minimum 1).
    **Default:** `8`.
* Returns: [`readlinePromises.Interface`](/api/v20/readline#readlinepromisesinterface)
...
* `stream` [`stream.Writable`](/api/v20/stream#streamwritable)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `tabSize` [`integer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) The number of spaces a tab is equal to (minimum 1).
    **Default:** `8`.
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal) Allows closing the interface using an AbortSignal.
    Aborting the signal will internally call `close` on the interface.
* Returns: [`readline.Interface`](/api/v20/readline#readlineinterface)
...
* `stream` [`stream.Readable`](/api/v20/stream#streamreadable)
* `interface` [`readline.InterfaceConstructor`](/api/v20/readline#interfaceconstructor)
