...
<Metadata version="v20.3.1" data={{"source_link":"lib/zlib.js"}} />
...
* `options` [`brotli options`](/api/v20/zlib#brotlioptions)
...
* `options` [`zlib options`](/api/v20/zlib#options)
...
[`buffer.kMaxLength`]: /api/v20/buffer#bufferkmaxlength
[`deflateInit2` and `inflateInit2`]: https://zlib.net/manual.html#Advanced
[`stream.Transform`]: /api/v20/stream#class-streamtransform
