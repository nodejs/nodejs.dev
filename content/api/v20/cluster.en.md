...
<Metadata version="v20.3.1" data={{"source_link":"lib/cluster.js"}} />
...
* Returns: [`cluster.Worker`](/api/v20/cluster#worker) A reference to `worker`.
...
* [`ChildProcess`](/api/v20/child_process#childprocess)
...
* `worker` [`cluster.Worker`](/api/v20/cluster#worker)
...
* Returns: [`cluster.Worker`](/api/v20/cluster#worker)
...
[`kill()`]: /api/v20/process#processkillpid-signal
[`process` event: `'message'`]: /api/v20/process#event-message
[`server.close()`]: /api/v20/net#event-close
