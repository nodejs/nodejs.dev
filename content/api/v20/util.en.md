...
<Metadata version="v20.3.1" data={{"source_link":"lib/util.js"}} />
...
Creates and returns an [`AbortController`](/api/v20/globals#abortcontroller) instance whose [`AbortSignal`](/api/v20/globals#abortsignal) is marked
...
Marks the given [`AbortSignal`](/api/v20/globals#abortsignal) as transferable so that it can be used with
...
Returns `true` if `value` is a [`CryptoKey`](/api/v20/webcrypto#cryptokey), `false` otherwise.
...
Returns `true` if `value` is a [`KeyObject`](/api/v20/crypto#keyobject), `false` otherwise.
...
[Internationalization]: /api/v20/intl
...
[`assert.deepStrictEqual()`]: /api/v20/assert#assertdeepstrictequalactual-expected-message
...
[`tty.hasColors()`]: /api/v20/tty#writestreamhascolorscount-env
...
[list of deprecated APIS]: /api/v20/deprecations#list-of-deprecated-apis
