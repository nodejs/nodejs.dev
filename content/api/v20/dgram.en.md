...
<Metadata version="v20.3.1" data={{"source_link":"lib/dgram.js"}} />
...
* `msg` [`Buffer`](/api/v20/buffer#buffer) The message.
...
<Metadata data={{"update":{"type":"added","version":["v18.8.0","v16.19.0"]}}} />
...
* Returns: [`dgram.Socket`](/api/v20/dgram#dgramsocket)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) Available options are:
  ...
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal) An AbortSignal that may be used to close a socket.
...
[`'close'`]: #event-close
[`ERR_SOCKET_BAD_PORT`]: /api/v20/errors#err_socket_bad_port
[`ERR_SOCKET_BUFFER_SIZE`]: /api/v20/errors#err_socket_buffer_size
[`ERR_SOCKET_DGRAM_IS_CONNECTED`]: /api/v20/errors#err_socket_dgram_is_connected
[`ERR_SOCKET_DGRAM_NOT_CONNECTED`]: /api/v20/errors#err_socket_dgram_not_connected
[`Error`]: /api/v20/errors#class-error
[`System Error`]: /api/v20/errors#class-systemerror
...
[byte length]: /api/v20/buffer#static-method-bufferbytelengthstring-encoding
