...
<Metadata version="v20.3.1" data={{"source_link":"lib/http.js"}} />
...
This method is guaranteed to return an instance of the [`net.Socket`](/api/v20/net#netsocket) class,
a subclass of [`stream.Duplex`](/api/v20/stream#streamduplex), unless the user specifies a socket
type other than [`net.Socket`](/api/v20/net#netsocket).
...
The `socket` argument can be an instance of [`net.Socket`](/api/v20/net#netsocket), a subclass of
[`stream.Duplex`](/api/v20/stream#streamduplex).
...
<Metadata data={{"changes":[{"version":["v17.7.0","v16.15.0"],"pr-url":"https://github.com/nodejs/node/pull/41906","description":"The `options` parameter is now optional."}],"update":{"type":"added","version":["v0.11.4"]}}} />
...
* Extends: [`http.OutgoingMessage`](/api/v20/http#httpoutgoingmessage)
...
* `socket` [`stream.Duplex`](/api/v20/stream#streamduplex)
* `head` [`Buffer`](/api/v20/buffer#buffer)

Emitted each time a server responds to a request with a `CONNECT` method. If
this event is not being listened for, clients receiving a `CONNECT` method will
have their connections closed.

This event is guaranteed to be passed an instance of the [`net.Socket`](/api/v20/net#netsocket) class,
a subclass of [`stream.Duplex`](/api/v20/stream#streamduplex), unless the user specifies a socket
type other than [`net.Socket`](/api/v20/net#netsocket).
...
This property is guaranteed to be an instance of the [`net.Socket`](/api/v20/net#netsocket) class,
a subclass of [`stream.Duplex`](/api/v20/stream#streamduplex), unless the user specified a socket
type other than [`net.Socket`](/api/v20/net#netsocket).
...
* `chunk` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v20/buffer#buffer) | [`Uint8Array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
* `encoding` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type)
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
* Returns: [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type)
...
* `request` [`http.IncomingMessage`](/api/v20/http#httpincomingmessage) Arguments for the HTTP request, as it is in
  the [`'request'`][] event
* `socket` [`stream.Duplex`](/api/v20/stream#streamduplex) Network socket between the server and client
* `head` [`Buffer`](/api/v20/buffer#buffer) The first packet of the tunneling stream (may be empty)
...
* `request` [`http.IncomingMessage`](/api/v20/http#httpincomingmessage) Arguments for the HTTP request, as it is in
  the [`'request'`][] event
* `socket` [`stream.Duplex`](/api/v20/stream#streamduplex) Network socket between the server and client
* `head` [`Buffer`](/api/v20/buffer#buffer) The first packet of the upgraded stream (may be empty)
...
<Metadata data={{"changes":[{"version":["v19.4.0","v18.14.0"],"pr-url":"https://github.com/nodejs/node/pull/45778","description":"The default is now set to the minimum between 60000 (60 seconds) or `requestTimeout`."}],"update":{"type":"added","version":["v11.3.0","v10.14.0"]}}} />
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
* Returns: [`http.Server`](/api/v20/http#httpserver)
...
* [`http.IncomingMessage`](/api/v20/http#httpincomingmessage)
...
* `name` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type)
* `value` [`any`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Data_types)
* Returns: [`http.ServerResponse`](/api/v20/http#httpserverresponse)
...
Different from its `socket` value which is a subclass of [`stream.Duplex`](/api/v20/stream#streamduplex), the
`IncomingMessage` itself extends [`stream.Readable`](/api/v20/stream#streamreadable) and is created separately to
...
* `msecs` [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type)
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
* Returns: [`http.IncomingMessage`](/api/v20/http#httpincomingmessage)
...
This property is guaranteed to be an instance of the [`net.Socket`](/api/v20/net#netsocket) class,
a subclass of [`stream.Duplex`](/api/v20/stream#streamduplex), unless the user specified a socket
type other than [`net.Socket`](/api/v20/net#netsocket) or internally nulled.
...
* Extends: [`Stream`](/api/v20/stream#stream)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `insecureHTTPParser` [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) Use an insecure HTTP parser that accepts
    ...
    **Default:** `false`.
  * `IncomingMessage` [`http.IncomingMessage`](/api/v20/http#httpincomingmessage) Specifies the `IncomingMessage`
  ...
  * `requestTimeout`: Sets the timeout value in milliseconds for receiving
    ...
    **Default:** `300000`.
  * `requireHostHeader` [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) It forces the server to respond with
  ...
  * `joinDuplicateHeaders` [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) It joins the field line values of multiple
    ...
    **Default:** `false`.
  * `ServerResponse` [`http.ServerResponse`](/api/v20/http#httpserverresponse) Specifies the `ServerResponse` class
...
* [`http.Agent`](/api/v20/http#httpagent)
...
* `url` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`URL`](/api/v20/url#the-whatwg-url-api)
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `agent` [`http.Agent`](/api/v20/http#httpagent) | [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) Controls [`Agent`][] behavior. Possible
    values:
  ...
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal): An AbortSignal that may be used to abort an ongoing
    request.
...
<Metadata data={{"changes":[{"version":["v19.5.0","v18.14.0"],"pr-url":"https://github.com/nodejs/node/pull/46143","description":"The `label` parameter is added."}],"update":{"type":"added","version":["v14.3.0"]}}} />
...
[`'ERR_HTTP_CONTENT_LENGTH_MISMATCH'`]: /api/v20/errors#err_http_content_length_mismatch
[`'checkContinue'`]: #event-checkcontinue
[`'finish'`]: #event-finish
[`'request'`]: #event-request
[`'response'`]: #event-response
[`'upgrade'`]: #event-upgrade
[`--insecure-http-parser`]: /api/v20/cli#--insecure-http-parser
[`--max-http-header-size`]: /api/v20/cli#--max-http-header-sizesize
...
[`HPE_HEADER_OVERFLOW`]: /api/v20/errors#hpe_header_overflow
[`Headers`]: /api/v20/globals#class-headers
...
[`net.Server.close()`]: /api/v20/net#serverclosecallback
[`net.Server`]: /api/v20/net#class-netserver
[`net.Socket`]: /api/v20/net#class-netsocket
[`net.createConnection()`]: /api/v20/net#netcreateconnectionoptions-connectlistener
...
[`request.socket.getPeerCertificate()`]: /api/v20/tls#tlssocketgetpeercertificatedetailed
...
[`socket.setKeepAlive()`]: /api/v20/net#socketsetkeepaliveenable-initialdelay
[`socket.setNoDelay()`]: /api/v20/net#socketsetnodelaynodelay
[`socket.setTimeout()`]: /api/v20/net#socketsettimeouttimeout-callback
[`socket.unref()`]: /api/v20/net#socketunref
...
[`writable.cork()`]: /api/v20/stream#writablecork
[`writable.destroy()`]: /api/v20/stream#writabledestroyerror
[`writable.destroyed`]: /api/v20/stream#writabledestroyed
[`writable.uncork()`]: /api/v20/stream#writableuncork
[`writable.write()`]: /api/v20/stream#writablewritechunk-encoding-callback
[initial delay]: /api/v20/net#socketsetkeepaliveenable-initialdelay
