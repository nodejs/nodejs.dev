...
<Metadata data={{"changes":[{"version":"v15.0.0","pr-url":"https://github.com/nodejs/node/pull/35316","description":"End-of-Life."},{"version":"v7.0.0","pr-url":"https://github.com/nodejs/node/pull/8217","description":"Runtime deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":["v6.12.0","v4.8.6"],"pr-url":"https://github.com/nodejs/node/pull/10116","description":"A deprecation code has been assigned."},{"version":"v1.0.0","pr-url":"https://github.com/nodejs/node/pull/166","description":"Documentation-only deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/19187","description":"End-of-Life."},{"version":"v8.0.0","pr-url":"https://github.com/nodejs/node/pull/11599","description":"Documentation-only deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/17141","description":"End-of-Life."},{"version":"v9.0.0","pr-url":"https://github.com/nodejs/node/pull/14449","description":"Runtime deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/47182","description":"End-of-Life."},{"version":"v10.0.0","pr-url":"https://github.com/nodejs/node/pull/18333","description":"Runtime deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":"v12.0.0","pr-url":"https://github.com/nodejs/node/pull/23760","description":"Runtime deprecation."}]}} />
...
The `'gc'`, `'http2'`, and `'http'` [`PerformanceEntry`](/api/v20/perf_hooks#performanceentry) object types have
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/45653","description":"Runtime deprecation."},{"version":"v16.10.0","pr-url":"https://github.com/nodejs/node/pull/39927","description":"Documentation-only deprecation."}]}} />
...
Move to [`Stream`](/api/v20/stream#stream) API instead, as the [`http.ClientRequest`][],
...
<Metadata data={{"changes":[{"version":"v19.9.0","pr-url":"https://github.com/nodejs/node/pull/47203","description":"Added support for `--pending-deprecation`."},{"version":["v19.0.0","v18.13.0"],"pr-url":"https://github.com/nodejs/node/pull/44919","description":"Documentation-only deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":["v20.0.0"],"pr-url":"https://github.com/nodejs/node/pull/45526","description":"Runtime deprecation."},{"version":["v19.2.0","v18.13.0"],"pr-url":"https://github.com/nodejs/node/pull/45576","description":"Documentation-only deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":["v19.3.0","v18.13.0"],"pr-url":"https://github.com/nodejs/node/pull/45697","description":"Documentation-only deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/46432","description":"Runtime-deprecation."}]}} />
...
<Metadata data={{"changes":[{"version":"v20.1.0","pr-url":"https://github.com/nodejs/node/pull/47740","description":"Documentation-only deprecation."}]}} />
...
[`"exports"` or `"main"` entry]: /api/v20/packages#main-entry-point-export
[`'uncaughtException'`]: /api/v20/process#event-uncaughtexception
[`--force-node-api-uncaught-exceptions-policy`]: /api/v20/cli#--force-node-api-uncaught-exceptions-policy
[`--pending-deprecation`]: /api/v20/cli#--pending-deprecation
[`--throw-deprecation`]: /api/v20/cli#--throw-deprecation
[`--trace-atomics-wait`]: /api/v20/cli#--trace-atomics-wait
[`--unhandled-rejections`]: /api/v20/cli#--unhandled-rejectionsmode
[`Buffer.allocUnsafeSlow(size)`]: /api/v20/buffer#static-method-bufferallocunsafeslowsize
[`Buffer.from(array)`]: /api/v20/buffer#static-method-bufferfromarray
[`Buffer.from(buffer)`]: /api/v20/buffer#static-method-bufferfrombuffer
[`Buffer.isBuffer()`]: /api/v20/buffer#static-method-bufferisbufferobj
[`Cipher`]: /api/v20/crypto#class-cipher
[`Decipher`]: /api/v20/crypto#class-decipher
[`REPLServer.clearBufferedCommand()`]: /api/v20/repl#replserverclearbufferedcommand
[`ReadStream.open()`]: /api/v20/fs#class-fsreadstream
[`Server.getConnections()`]: /api/v20/net#servergetconnectionscallback
[`Server.listen({fd: <number>})`]: /api/v20/net#serverlistenhandle-backlog-callback
[`SlowBuffer`]: /api/v20/buffer#class-slowbuffer
[`WriteStream.open()`]: /api/v20/fs#class-fswritestream
[`assert.CallTracker`]: /api/v20/assert#class-assertcalltracker
[`assert`]: /api/v20/assert
[`asyncResource.runInAsyncScope()`]: async_context.md#asyncresourceruninasyncscopefn-thisarg-args
[`buffer.subarray`]: /api/v20/buffer#bufsubarraystart-end
[`child_process`]: child_process.md
[`clearInterval()`]: /api/v20/timers#clearintervaltimeout
[`clearTimeout()`]: /api/v20/timers#cleartimeouttimeout
[`console.error()`]: /api/v20/console#consoleerrordata-args
[`console.log()`]: /api/v20/console#consolelogdata-args
[`crypto.Certificate()` constructor]: /api/v20/crypto#legacy-api
[`crypto.createCipher()`]: /api/v20/crypto#cryptocreatecipheralgorithm-password-options
[`crypto.createCipheriv()`]: /api/v20/crypto#cryptocreatecipherivalgorithm-key-iv-options
[`crypto.createDecipher()`]: /api/v20/crypto#cryptocreatedecipheralgorithm-password-options
[`crypto.createDecipheriv()`]: /api/v20/crypto#cryptocreatedecipherivalgorithm-key-iv-options
[`crypto.fips`]: /api/v20/crypto#cryptofips
[`crypto.pbkdf2()`]: /api/v20/crypto#cryptopbkdf2password-salt-iterations-keylen-digest-callback
[`crypto.randomBytes()`]: /api/v20/crypto#cryptorandombytessize-callback
[`crypto.scrypt()`]: /api/v20/crypto#cryptoscryptpassword-salt-keylen-options-callback
[`decipher.final()`]: /api/v20/crypto#decipherfinaloutputencoding
[`decipher.setAuthTag()`]: /api/v20/crypto#deciphersetauthtagbuffer-encoding
...
[`dnsPromises.lookup()`]: /api/v20/dns#dnspromiseslookuphostname-options
[`domain`]: /api/v20/domain
[`ecdh.setPublicKey()`]: /api/v20/crypto#ecdhsetpublickeypublickey-encoding
[`emitter.listenerCount(eventName)`]: /api/v20/events#emitterlistenercounteventname-listener
[`events.listenerCount(emitter, eventName)`]: /api/v20/events#eventslistenercountemitter-eventname
[`fs.FileHandle`]: /api/v20/fs#class-filehandle
[`fs.access()`]: /api/v20/fs#fsaccesspath-mode-callback
[`fs.appendFile()`]: /api/v20/fs#fsappendfilepath-data-options-callback
[`fs.appendFileSync()`]: /api/v20/fs#fsappendfilesyncpath-data-options
[`fs.createReadStream()`]: /api/v20/fs#fscreatereadstreampath-options
[`fs.createWriteStream()`]: /api/v20/fs#fscreatewritestreampath-options
[`fs.exists(path, callback)`]: /api/v20/fs#fsexistspath-callback
[`fs.lchmod(path, mode, callback)`]: /api/v20/fs#fslchmodpath-mode-callback
[`fs.lchmodSync(path, mode)`]: /api/v20/fs#fslchmodsyncpath-mode
[`fs.lchown(path, uid, gid, callback)`]: /api/v20/fs#fslchownpath-uid-gid-callback
[`fs.lchownSync(path, uid, gid)`]: /api/v20/fs#fslchownsyncpath-uid-gid
[`fs.read()`]: /api/v20/fs#fsreadfd-buffer-offset-length-position-callback
[`fs.readSync()`]: /api/v20/fs#fsreadsyncfd-buffer-offset-length-position
[`fs.stat()`]: /api/v20/fs#fsstatpath-options-callback
[`fs.write()`]: /api/v20/fs#fswritefd-buffer-offset-length-position-callback
[`fs.writeFile()`]: /api/v20/fs#fswritefilefile-data-options-callback
[`fs.writeFileSync()`]: /api/v20/fs#fswritefilesyncfile-data-options
[`http.ClientRequest`]: /api/v20/http#class-httpclientrequest
[`http.IncomingMessage`]: /api/v20/http#class-httpincomingmessage
[`http.ServerResponse`]: /api/v20/http#class-httpserverresponse
[`http.get()`]: /api/v20/http#httpgetoptions-callback
[`http.request()`]: /api/v20/http#httprequestoptions-callback
[`https.get()`]: /api/v20/https#httpsgetoptions-callback
[`https.request()`]: /api/v20/https#httpsrequestoptions-callback
[`message.connection`]: /api/v20/http#messageconnection
[`message.headersDistinct`]: /api/v20/http#messageheadersdistinct
[`message.headers`]: /api/v20/http#messageheaders
[`message.socket`]: /api/v20/http#messagesocket
[`message.trailersDistinct`]: /api/v20/http#messagetrailersdistinct
[`message.trailers`]: /api/v20/http#messagetrailers
[`mock`]: /api/v20/test#mocking
[`module.createRequire()`]: /api/v20/module#modulecreaterequirefilename
[`os.networkInterfaces()`]: /api/v20/os#osnetworkinterfaces
[`os.tmpdir()`]: /api/v20/os#ostmpdir
[`process.env`]: /api/v20/process#processenv
[`process.exit()`]: /api/v20/process#processexitcode
[`process.exitCode`]: /api/v20/process#processexitcode_1
[`process.getActiveResourcesInfo()`]: /api/v20/process#processgetactiveresourcesinfo
[`process.mainModule`]: /api/v20/process#processmainmodule
[`punycode`]: /api/v20/punycode
[`readable.readableEnded`]: /api/v20/stream#readablereadableended
[`request.abort()`]: /api/v20/http#requestabort
[`request.connection`]: /api/v20/http#requestconnection
[`request.destroy()`]: /api/v20/http#requestdestroyerror
[`request.socket`]: /api/v20/http#requestsocket
[`require.extensions`]: /api/v20/modules#requireextensions
[`require.main`]: /api/v20/modules#accessing-the-main-module
[`response.connection`]: /api/v20/http#responseconnection
[`response.end()`]: /api/v20/http#responseenddata-encoding-callback
[`response.finished`]: /api/v20/http#responsefinished
[`response.socket`]: /api/v20/http#responsesocket
[`response.writableEnded`]: /api/v20/http#responsewritableended
[`response.writableFinished`]: /api/v20/http#responsewritablefinished
[`script.createCachedData()`]: /api/v20/vm#scriptcreatecacheddata
[`setInterval()`]: /api/v20/timers#setintervalcallback-delay-args
[`setTimeout()`]: /api/v20/timers#settimeoutcallback-delay-args
[`socket.bufferSize`]: /api/v20/net#socketbuffersize
[`timeout.ref()`]: /api/v20/timers#timeoutref
[`timeout.refresh()`]: /api/v20/timers#timeoutrefresh
[`timeout.unref()`]: /api/v20/timers#timeoutunref
[`tls.CryptoStream`]: /api/v20/tls#class-tlscryptostream
[`tls.SecureContext`]: /api/v20/tls#tlscreatesecurecontextoptions
[`tls.SecurePair`]: /api/v20/tls#class-tlssecurepair
[`tls.TLSSocket`]: /api/v20/tls#class-tlstlssocket
[`tls.checkServerIdentity()`]: /api/v20/tls#tlscheckserveridentityhostname-cert
[`tls.createSecureContext()`]: /api/v20/tls#tlscreatesecurecontextoptions
[`url.format()`]: /api/v20/url#urlformaturlobject
[`url.parse()`]: /api/v20/url#urlparseurlstring-parsequerystring-slashesdenotehost
[`url.resolve()`]: /api/v20/url#urlresolvefrom-to
[`util._extend()`]: /api/v20/util#util_extendtarget-source
[`util.getSystemErrorName()`]: /api/v20/util#utilgetsystemerrornameerr
[`util.inspect()`]: /api/v20/util#utilinspectobject-options
[`util.inspect.custom`]: /api/v20/util#utilinspectcustom
[`util.isArray()`]: /api/v20/util#utilisarrayobject
[`util.isBoolean()`]: /api/v20/util#utilisbooleanobject
[`util.isBuffer()`]: /api/v20/util#utilisbufferobject
[`util.isDate()`]: /api/v20/util#utilisdateobject
[`util.isError()`]: /api/v20/util#utiliserrorobject
[`util.isFunction()`]: /api/v20/util#utilisfunctionobject
[`util.isNull()`]: /api/v20/util#utilisnullobject
[`util.isNullOrUndefined()`]: /api/v20/util#utilisnullorundefinedobject
[`util.isNumber()`]: /api/v20/util#utilisnumberobject
[`util.isObject()`]: /api/v20/util#utilisobjectobject
[`util.isPrimitive()`]: /api/v20/util#utilisprimitiveobject
[`util.isRegExp()`]: /api/v20/util#utilisregexpobject
[`util.isString()`]: /api/v20/util#utilisstringobject
[`util.isSymbol()`]: /api/v20/util#utilissymbolobject
[`util.isUndefined()`]: /api/v20/util#utilisundefinedobject
[`util.log()`]: /api/v20/util#utillogstring
[`util.types`]: /api/v20/util#utiltypes
[`util`]: /api/v20/util
[`worker.exitedAfterDisconnect`]: /api/v20/cluster#workerexitedafterdisconnect
[`worker.terminate()`]: worker_threads.md#workerterminate
[`writable.writableLength`]: /api/v20/stream#writablewritablelength
[`zlib.bytesWritten`]: /api/v20/zlib#zlibbyteswritten
[alloc]: /api/v20/buffer#static-method-bufferallocsize-fill-encoding
[alloc_unsafe_size]: /api/v20/buffer#static-method-bufferallocunsafesize
[from_arraybuffer]: /api/v20/buffer#static-method-bufferfromarraybuffer-byteoffset-length
[from_string_encoding]: /api/v20/buffer#static-method-bufferfromstring-encoding
[legacy URL API]: /api/v20/url#legacy-url-api
[legacy `urlObject`]: /api/v20/url#legacy-urlobject
[static methods of `crypto.Certificate()`]: /api/v20/crypto#class-certificate
[subpath exports]: /api/v20/packages#subpath-exports
[subpath imports]: /api/v20/packages#subpath-imports
[subpath patterns]: /api/v20/packages#subpath-patterns
