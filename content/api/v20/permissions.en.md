...
<Metadata data={{"name":"permission-model"}} />
...
[`--allow-child-process`]: /api/v20/cli#--allow-child-process
[`--allow-fs-read`]: /api/v20/cli#--allow-fs-read
[`--allow-fs-write`]: /api/v20/cli#--allow-fs-write
[`--allow-worker`]: /api/v20/cli#--allow-worker
[`--experimental-permission`]: /api/v20/cli#--experimental-permission
[`permission.has()`]: /api/v20/process#processpermissionhasscope-reference
