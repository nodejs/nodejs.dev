...
<Metadata version="v20.3.1" data={{"source_link":"lib/tls.js"}} />
...
* Extends: [`net.Server`](/api/v20/net#netserver)
...
* `socket` [`stream.Duplex`](/api/v20/stream#streamduplex)
...
* `sessionId` [`Buffer`](/api/v20/buffer#buffer) The TLS session identifier
* `sessionData` [`Buffer`](/api/v20/buffer#buffer) The TLS session data
...
* `certificate` [`Buffer`](/api/v20/buffer#buffer) The server certificate
* `issuer` [`Buffer`](/api/v20/buffer#buffer) The issuer's certificate
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) A callback function to be called when the prior session
  ...
  * `sessionData` [`Buffer`](/api/v20/buffer#buffer)
...
* `tlsSocket` [`tls.TLSSocket`](/api/v20/tls#tlstlssocket) The established TLS socket.
...
* `tlsSocket` [`tls.TLSSocket`](/api/v20/tls#tlstlssocket) The `tls.TLSSocket` instance from which the
  error originated.
...
* `context` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`tls.SecureContext`](/api/v20/tls#tlscreatesecurecontextoptions) An object containing any of the possible
...
* Returns: [`tls.Server`](/api/v20/tls#tlsserver)
...
* Returns: [`Buffer`](/api/v20/buffer#buffer) A 48-byte buffer containing the session ticket keys.
...
* `keys` [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) A 48-byte buffer containing the session
  ticket keys.
...
* `socket` [`net.Socket`](/api/v20/net#netsocket) | [`stream.Duplex`](/api/v20/stream#streamduplex)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `server` [`net.Server`](/api/v20/net#netserver) A [`net.Server`][] instance.
  ...
  * `session` [`Buffer`](/api/v20/buffer#buffer) A `Buffer` instance containing a TLS session.
...
* `response` [`Buffer`](/api/v20/buffer#buffer) The server's OCSP response
...
The `'secureConnect'` event is not emitted when a [`tls.TLSSocket`](/api/v20/tls#tlstlssocket) is created
...
* `session` [`Buffer`](/api/v20/buffer#buffer)
...
* `context` [`Buffer`](/api/v20/buffer#buffer) Optionally provide a context.

* Returns: [`Buffer`](/api/v20/buffer#buffer) requested bytes of the keying material
...
* Returns: [`Buffer`](/api/v20/buffer#buffer) | [`undefined`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Undefined_type) The latest `Finished` message that has been
...
* `raw` [`Buffer`](/api/v20/buffer#buffer) The DER encoded X.509 certificate data.
...
* `modulus` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) The RSA modulus, as a hexadecimal string. Example:
  `'B56CE45CB7...'`.
* `pubkey` [`Buffer`](/api/v20/buffer#buffer) The public key.
...
* Returns: [`Buffer`](/api/v20/buffer#buffer) | [`undefined`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Undefined_type) The latest `Finished` message that is expected
...
* Returns: [`X509Certificate`](/api/v20/crypto#x509certificate)

Returns the peer certificate as an [`X509Certificate`](/api/v20/crypto#x509certificate) object.
...
Returns the local certificate as an [`X509Certificate`](/api/v20/crypto#x509certificate) object.
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `socket` [`stream.Duplex`](/api/v20/stream#streamduplex) Establish secure connection on a given socket
  ...
  * `ALPNProtocols`: [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView)
  ...
  * `session` [`Buffer`](/api/v20/buffer#buffer) A `Buffer` instance, containing TLS session.
...
* Returns: [`tls.TLSSocket`](/api/v20/tls#tlstlssocket)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `cert` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v20/buffer#buffer) Cert chains in PEM format. One
  ...
  * `clientCertEngine` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) Name of an OpenSSL engine which can provide the
    client certificate.
  * `crl` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v20/buffer#buffer) PEM formatted CRLs (Certificate
    Revocation Lists).
  * `dhparam` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v20/buffer#buffer) `'auto'` or custom Diffie-Hellman parameters,
  ...
  * `key` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v20/buffer#buffer) Private keys in PEM
  ...
  * `passphrase` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) Shared passphrase used for a single private key and/or
    a PFX.
  * `pfx` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`Buffer`](/api/v20/buffer#buffer) PFX or PKCS12 encoded
  ...
  * `ticketKeys`: [`Buffer`](/api/v20/buffer#buffer) 48-bytes of cryptographically strong pseudorandom
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `pskCallback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
    ...
    * socket: [`tls.TLSSocket`](/api/v20/tls#tlstlssocket) the server [`tls.TLSSocket`][] instance for
      this connection.
    ...
    * Returns: [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) pre-shared key that must either be
...
[OpenSSL Options]: /api/v20/crypto#openssl-options
...
[`--tls-cipher-list`]: /api/v20/cli#--tls-cipher-listlist
[`Duplex`]: /api/v20/stream#class-streamduplex
[`NODE_OPTIONS`]: /api/v20/cli#node_optionsoptions
[`SSL_export_keying_material`]: https://www.openssl.org/docs/man1.1.1/man3/SSL_export_keying_material.html
[`SSL_get_version`]: https://www.openssl.org/docs/man1.1.1/man3/SSL_get_version.html
[`crypto.getCurves()`]: /api/v20/crypto#cryptogetcurves
[`import()`]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/import
[`net.Server.address()`]: /api/v20/net#serveraddress
[`net.Server`]: /api/v20/net#class-netserver
[`net.Socket`]: /api/v20/net#class-netsocket
[`net.createServer()`]: /api/v20/net#netcreateserveroptions-connectionlistener
...
[`socket.connect()`]: /api/v20/net#socketconnectoptions-connectlistener
...
[`x509.checkHost()`]: /api/v20/crypto#x509checkhostname-options
