...
<Metadata version="v20.3.1" data={{"source_link":"lib/domain.js"}} />
...
* Returns: [`Domain`](/api/v20/domain#domain)
...
* `emitter` [`EventEmitter`](/api/v20/events#eventemitter) | [`Timer`](/api/v20/timers#timers) emitter or timer to be added to the domain
...
* `emitter` [`EventEmitter`](/api/v20/events#eventemitter) | [`Timer`](/api/v20/timers#timers) emitter or timer to be removed from the domain
