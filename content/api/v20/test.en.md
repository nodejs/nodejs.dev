...
<Metadata version="v20.3.1" data={{"source_link":"lib/test.js"}} />
...
<Metadata data={{"changes":[{"version":"v19.9.0","pr-url":"https://github.com/nodejs/node/pull/47238","description":"Reporters are now exposed at `node:test/reporters`."}],"update":{"type":"added","version":["v19.6.0","v18.15.0"]}}} />
...
Example of a custom reporter using [`stream.Transform`](/api/v20/stream#streamtransform):
...
<Metadata data={{"changes":[{"version":"v20.1.0","pr-url":"https://github.com/nodejs/node/pull/47628","description":"Add a testNamePatterns option."}],"update":{"type":"added","version":["v18.9.0","v16.19.0"]}}} />
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) Configuration options for running tests. The following
  ...
  * `setup` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) A function that accepts the `TestsStream` instance
    ...
    **Default:** `undefined`.
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal) Allows aborting an in-progress test execution.
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) Configuration options for the test. The following
  ...
  * `only` [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) If truthy, and the test context is configured to run
    ...
    **Default:** `false`.
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal) Allows aborting an in-progress test.
...
### <DataTag tag="M" /> `test.skip([name][, options][, fn])`

Shorthand for skipping a test,
same as [`test([name], { skip: true }[, fn])`][it options].

### <DataTag tag="M" /> `test.todo([name][, options][, fn])`

Shorthand for marking a test as `TODO`,
same as [`test([name], { todo: true }[, fn])`][it options].

### <DataTag tag="M" /> `test.only([name][, options][, fn])`
...
<Metadata data={{"update":{"type":"added","version":["v19.8.0","v18.15.0"]}}} />
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) Configuration options for the hook. The following
  properties are supported:
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal) Allows aborting an in-progress hook.
...
<Metadata data={{"update":{"type":"added","version":["v19.3.0","v18.13.0"]}}} />
...
<Metadata data={{"update":{"type":"added","version":["v18.9.0","v16.19.0"]}}} />

* Extends [`ReadableStream`](/api/v20/webstreams#readablestream)
...
#### <DataTag tag="E" /> `'test:watch:drained'`

Emitted when no more tests are queued for execution in watch mode.

### <DataTag tag="C" /> `TestContext`

<Metadata data={{"changes":[{"version":"v20.1.0","pr-url":"https://github.com/nodejs/node/pull/47586","description":"The `before` function was added to TestContext."}],"update":{"type":"added","version":["v18.0.0","v16.17.0"]}}} />

An instance of `TestContext` is passed to each test function in order to
interact with the test runner. However, the `TestContext` constructor is not
exposed as part of the API.

#### <DataTag tag="M" /> `context.before([fn][, options])`
...
* [`AbortSignal`](/api/v20/globals#abortsignal) Can be used to abort test subtasks when the test has been
  aborted.
...
[TTY]: /api/v20/tty
[`--experimental-test-coverage`]: /api/v20/cli#--experimental-test-coverage
[`--import`]: /api/v20/cli#--importmodule
[`--test-name-pattern`]: /api/v20/cli#--test-name-pattern
[`--test-only`]: /api/v20/cli#--test-only
[`--test-reporter-destination`]: /api/v20/cli#--test-reporter-destination
[`--test-reporter`]: /api/v20/cli#--test-reporter
[`--test`]: /api/v20/cli#--test
[`MockFunctionContext`]: #class-mockfunctioncontext
[`MockTracker.method`]: #mockmethodobject-methodname-implementation-options
[`MockTracker`]: #class-mocktracker
[`NODE_V8_COVERAGE`]: /api/v20/cli#node_v8_coveragedir
...
[stream.compose]: /api/v20/stream#streamcomposestreams
