...
* `underlyingSource` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `start` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) A user-defined function that is invoked immediately when
    ...
    * `controller` [`ReadableStreamDefaultController`](/api/v20/webstreams#readablestreamdefaultcontroller) | [`ReadableByteStreamController`](/api/v20/webstreams#readablebytestreamcontroller)
...
* Type: [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) Set to `true` if there is an active reader for this
  [`ReadableStream`](/api/v20/webstreams#readablestream).
...
* Returns: [`ReadableStreamDefaultReader`](/api/v20/webstreams#readablestreamdefaultreader) | [`ReadableStreamBYOBReader`](/api/v20/webstreams#readablestreambyobreader)
...
* `transform` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `readable` [`ReadableStream`](/api/v20/webstreams#readablestream) The `ReadableStream` to which
    `transform.writable` will push the potentially modified data
    is receives from this `ReadableStream`.
  * `writable` [`WritableStream`](/api/v20/webstreams#writablestream) The `WritableStream` to which this
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal) Allows the transfer of data to be canceled
    using an [`AbortController`](/api/v20/globals#abortcontroller).
* Returns: [`ReadableStream`](/api/v20/webstreams#readablestream) From `transform.readable`.

Connects this [`ReadableStream`](/api/v20/webstreams#readablestream) to the pair of [`ReadableStream`](/api/v20/webstreams#readablestream) and
[`WritableStream`](/api/v20/webstreams#writablestream) provided in the `transform` argument such that the
data from this [`ReadableStream`](/api/v20/webstreams#readablestream) is written in to `transform.writable`,
...
* `destination` [`WritableStream`](/api/v20/webstreams#writablestream) A [`WritableStream`](/api/v20/webstreams#writablestream) to which this
  `ReadableStream`'s data will be written.
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `preventAbort` [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) When `true`, errors in this `ReadableStream`
...
Returns a pair of new [`ReadableStream`](/api/v20/webstreams#readablestream) instances to which this
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `preventCancel` [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) When `true`, prevents the [`ReadableStream`](/api/v20/webstreams#readablestream)
...
The [`ReadableStream`](/api/v20/webstreams#readablestream) object supports the async iterator protocol using
`for await` syntax.
...
The async iterator will consume the [`ReadableStream`](/api/v20/webstreams#readablestream) until it terminates.

By default, if the async iterator exits early (via either a `break`,
`return`, or a `throw`), the [`ReadableStream`](/api/v20/webstreams#readablestream) will be closed. To prevent
automatic closing of the [`ReadableStream`](/api/v20/webstreams#readablestream), use the `readableStream.values()`
method to acquire the async iterator and set the `preventCancel` option to
`true`.

The [`ReadableStream`](/api/v20/webstreams#readablestream) must not be locked (that is, it must not have an existing
active reader). During the async iteration, the [`ReadableStream`](/api/v20/webstreams#readablestream) will be locked.

##### Transferring with `postMessage()`

A [`ReadableStream`](/api/v20/webstreams#readablestream) instance can be transferred using a [`MessagePort`](/api/v20/worker_threads#messageport).
...
values, which allows the [`ReadableStream`](/api/v20/webstreams#readablestream) to work with generally any
JavaScript value.
...
* `stream` [`ReadableStream`](/api/v20/webstreams#readablestream)

Creates a new [`ReadableStreamDefaultReader`](/api/v20/webstreams#readablestreamdefaultreader) that is locked to the
given [`ReadableStream`](/api/v20/webstreams#readablestream).
...
Cancels the [`ReadableStream`](/api/v20/webstreams#readablestream) and returns a promise that is fulfilled
...
* Type: [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfilled with `undefined` when the associated
  [`ReadableStream`](/api/v20/webstreams#readablestream) is closed or rejected if the stream errors or the reader's
...
Requests the next chunk of data from the underlying [`ReadableStream`](/api/v20/webstreams#readablestream)
...
Releases this reader's lock on the underlying [`ReadableStream`](/api/v20/webstreams#readablestream).
...
byte-oriented [`ReadableStream`](/api/v20/webstreams#readablestream)s (those that are created with
...
* `view` [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView)
* Returns: A promise fulfilled with an object:
  * `value` [`ArrayBuffer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)
  * `done` [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type)
...
Do not pass a pooled [`Buffer`](/api/v20/buffer#buffer) object instance in to this method.
...
Every [`ReadableStream`](/api/v20/webstreams#readablestream) has a controller that is responsible for
...
Closes the [`ReadableStream`](/api/v20/webstreams#readablestream) to which this controller is associated.
...
Returns the amount of data remaining to fill the [`ReadableStream`](/api/v20/webstreams#readablestream)'s
queue.
...
Appends a new chunk of data to the [`ReadableStream`](/api/v20/webstreams#readablestream)'s queue.
...
Signals an error that causes the [`ReadableStream`](/api/v20/webstreams#readablestream) to error and close.
...
* Type: [`ReadableStreamBYOBRequest`](/api/v20/webstreams#readablestreambyobrequest)
...
* `chunk`: [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView)
...
* Type: [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView)
...
* `underlyingSink` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `start` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) A user-defined function that is invoked immediately when
    ...
    * `controller` [`WritableStreamDefaultController`](/api/v20/webstreams#writablestreamdefaultcontroller)
    * Returns: `undefined` or a promise fulfilled with `undefined`.
...
* Returns: [`WritableStreamDefaultWriter`](/api/v20/webstreams#writablestreamdefaultwriter)
...
A [`WritableStream`](/api/v20/webstreams#writablestream) instance can be transferred using a [`MessagePort`](/api/v20/worker_threads#messageport).
...
* `stream` [`WritableStream`](/api/v20/webstreams#writablestream)
...
* Type: [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfilled with `undefined` when the associated
  [`WritableStream`](/api/v20/webstreams#writablestream) is closed or rejected if the stream errors or the writer's
  lock is released before the stream finishes closing.
...
The amount of data required to fill the [`WritableStream`](/api/v20/webstreams#writablestream)'s queue.
...
Releases this writer's lock on the underlying [`ReadableStream`](/api/v20/webstreams#readablestream).
...
Appends a new chunk of data to the [`WritableStream`](/api/v20/webstreams#writablestream)'s queue.

#### <DataTag tag="C" /> `WritableStreamDefaultController`

<Metadata data={{"changes":[{"version":"v18.0.0","pr-url":"https://github.com/nodejs/node/pull/42225","description":"This class is now exposed on the global object."}],"update":{"type":"added","version":["v16.5.0"]}}} />

The `WritableStreamDefaultController` manage's the [`WritableStream`](/api/v20/webstreams#writablestream)'s
internal state.
...
the `WritableStream` data. When called, the [`WritableStream`](/api/v20/webstreams#writablestream) will be aborted,
with currently pending writes canceled.

##### <DataTag tag="M" /> `writableStreamDefaultController.signal`

* Type: [`AbortSignal`](/api/v20/globals#abortsignal) An `AbortSignal` that can be used to cancel pending
  write or close operations when a [`WritableStream`](/api/v20/webstreams#writablestream) is aborted.

#### <DataTag tag="C" /> `TransformStream`

<Metadata data={{"changes":[{"version":"v18.0.0","pr-url":"https://github.com/nodejs/node/pull/42225","description":"This class is now exposed on the global object."}],"update":{"type":"added","version":["v16.5.0"]}}} />

A `TransformStream` consists of a [`ReadableStream`](/api/v20/webstreams#readablestream) and a [`WritableStream`](/api/v20/webstreams#writablestream) that
...
* `transformer` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `start` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) A user-defined function that is invoked immediately when
    ...
    * `controller` [`TransformStreamDefaultController`](/api/v20/webstreams#transformstreamdefaultcontroller)
    * Returns: `undefined` or a promise fulfilled with `undefined`
...
* Type: [`ReadableStream`](/api/v20/webstreams#readablestream)

##### <DataTag tag="M" /> `transformStream.writable`

<Metadata data={{"update":{"type":"added","version":["v16.5.0"]}}} />

* Type: [`WritableStream`](/api/v20/webstreams#writablestream)

##### Transferring with postMessage()

A [`TransformStream`](/api/v20/webstreams#transformstream) instance can be transferred using a [`MessagePort`](/api/v20/worker_threads#messageport).
...
* `stream` [`ReadableStream`](/api/v20/webstreams#readablestream) | [`stream.Readable`](/api/v20/stream#streamreadable) | [`AsyncIterator`](https://tc39.github.io/ecma262/#sec-asynciterator-interface)
...
* `stream` [`ReadableStream`](/api/v20/webstreams#readablestream) | [`stream.Readable`](/api/v20/stream#streamreadable) | [`AsyncIterator`](https://tc39.github.io/ecma262/#sec-asynciterator-interface)
* Returns: [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with a [`Blob`](/api/v20/buffer#blob) containing the full contents
  of the stream.
...
* `stream` [`ReadableStream`](/api/v20/webstreams#readablestream) | [`stream.Readable`](/api/v20/stream#streamreadable) | [`AsyncIterator`](https://tc39.github.io/ecma262/#sec-asynciterator-interface)
* Returns: [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with a [`Buffer`](/api/v20/buffer#buffer) containing the full
  contents of the stream.
