...
<Metadata version="v20.3.1" data={{"source_link":"lib/vm.js"}} />
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type)
  ...
  * `cachedData` [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) Provides an optional `Buffer` or
  ...
  * `importModuleDynamically` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) Called during evaluation of this module
    ...
    * `script` [`vm.Script`](/api/v20/vm#vmscript)
    * `importAssertions` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) The `"assert"` value passed to the
      ...
      was provided.
    * Returns: [`Module Namespace Object`](https://tc39.github.io/ecma262/#sec-module-namespace-exotic-objects) | [`vm.Module`](/api/v20/vm#vmmodule) Returning a `vm.Module` is
...
* `linker` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  ...
  * `referencingModule` [`vm.Module`](/api/v20/vm#vmmodule) The `Module` object `link()` is called on.
  ...
  * Returns: [`vm.Module`](/api/v20/vm#vmmodule) | [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)
...
* Extends: [`vm.Module`](/api/v20/vm#vmmodule)
...
* `options`
  ...
  * `initializeImportMeta` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) Called during evaluation of this `Module`
    ...
    * `meta` [`import.meta`](/api/v20/esm#importmeta)
    * `module` [`vm.SourceTextModule`](/api/v20/vm#vmsourcetextmodule)
  * `importModuleDynamically` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) Called during evaluation of this module
    when `import()` is called. If this option is not specified, calls to
    `import()` will reject with [`ERR_VM_DYNAMIC_IMPORT_CALLBACK_MISSING`][].
    * `specifier` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) specifier passed to `import()`
    * `module` [`vm.Module`](/api/v20/vm#vmmodule)
    * `importAssertions` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) The `"assert"` value passed to the
      [`optionsExpression`][] optional parameter, or an empty object if no value
      was provided.
    * Returns: [`Module Namespace Object`](https://tc39.github.io/ecma262/#sec-module-namespace-exotic-objects) | [`vm.Module`](/api/v20/vm#vmmodule) Returning a `vm.Module` is
...
[ECMAScript Module Loader]: /api/v20/esm#modules-ecmascript-modules
...
[`ERR_VM_DYNAMIC_IMPORT_CALLBACK_MISSING`]: /api/v20/errors#err_vm_dynamic_import_callback_missing
[`ERR_VM_MODULE_STATUS`]: /api/v20/errors#err_vm_module_status
...
[`url.origin`]: /api/v20/url#urlorigin
