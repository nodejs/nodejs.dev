...
#### <DataTag tag="M" /> `--allow-child-process`
...
#### <DataTag tag="M" /> `--no-network-family-autoselection`

<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/46790","description":"The flag was renamed from `--no-enable-network-family-autoselection` to `--no-network-family-autoselection`. The old name can still work as an alias."}],"update":{"type":"added","version":["v19.4.0"]}}} />
...
<Metadata data={{"update":{"type":"added","version":["v17.6.0","v16.15.0"]}}} />
...
#### <DataTag tag="M" /> `--experimental-permission`
...
#### <DataTag tag="M" /> `--experimental-sea-config`
...
<Metadata data={{"update":{"type":"added","version":["v19.0.0","v18.13.0"]}}} />

Use this flag to enable [ShadowRealm][] support.

#### <DataTag tag="M" /> `--experimental-test-coverage`

<Metadata data={{"changes":[{"version":"v20.1.0","pr-url":"https://github.com/nodejs/node/pull/47686","description":"This option can be used with `--test`."}],"update":{"type":"added","version":["v19.7.0","v18.15.0"]}}} />
...
<Metadata data={{"update":{"type":"added","version":["v18.5.0","v16.17.0","v14.21.0"]}}} />
...
<Metadata data={{"update":{"type":"added","version":["v17.0.0","v16.17.0"]}}} />
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/46983","description":"The test runner is now stable."},{"version":["v19.2.0","v18.13.0"],"pr-url":"https://github.com/nodejs/node/pull/45214","description":"Test runner now supports running in watch mode."}],"update":{"type":"added","version":["v18.1.0","v16.17.0"]}}} />
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/46983","description":"The test runner is now stable."}],"update":{"type":"added","version":["v18.11.0"]}}} />
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/46983","description":"The test runner is now stable."}],"update":{"type":"added","version":["v19.6.0","v18.15.0"]}}} />
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/46983","description":"The test runner is now stable."}],"update":{"type":"added","version":["v18.0.0","v16.17.0"]}}} />
...
<Metadata data={{"update":{"type":"deprecated","version":["v18.8.0","v16.18.0"]}}} />
...
<Metadata data={{"changes":[{"version":["v19.2.0","v18.13.0"],"pr-url":"https://github.com/nodejs/node/pull/45214","description":"Test runner now supports running in watch mode."}],"update":{"type":"added","version":["v18.11.0","v16.19.0"]}}} />
...
<Metadata data={{"update":{"type":"added","version":["v18.11.0","v16.19.0"]}}} />
...
#### <DataTag tag="M" /> `NODE_TEST_CONTEXT=value`
...
[ECMAScript module]: /api/v20/esm#modules-ecmascript-modules
[ECMAScript module loader]: /api/v20/esm#loaders
[Fetch API]: https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API
[File System Permissions]: /api/v20/permissions#file-system-permissions
[Modules loaders]: /api/v20/packages#modules-loaders
...
[`Buffer`]: /api/v20/buffer#class-buffer
...
[`dns.setDefaultResultOrder()`]: /api/v20/dns#dnssetdefaultresultorderorder
[`dnsPromises.lookup()`]: /api/v20/dns#dnspromiseslookuphostname-options
[`import` specifier]: /api/v20/esm#import-specifiers
[`process.setUncaughtExceptionCaptureCallback()`]: /api/v20/process#processsetuncaughtexceptioncapturecallbackfn
[`tls.DEFAULT_MAX_VERSION`]: /api/v20/tls#tlsdefault_max_version
[`tls.DEFAULT_MIN_VERSION`]: /api/v20/tls#tlsdefault_min_version
[`unhandledRejection`]: /api/v20/process#event-unhandledrejection
[`v8.startupSnapshot` API]: v8.md#startup-snapshot-api
[`worker_threads.threadId`]: worker_threads.md#workerthreadid
[collecting code coverage from tests]: /api/v20/test#collecting-code-coverage
[conditional exports]: /api/v20/packages#conditional-exports
[context-aware]: /api/v20/addons#context-aware-addons
[debugger]: /api/v20/debugger
[debugging security implications]: https://nodejs.org/en/docs/guides/debugging-getting-started/#security-implications
[emit_warning]: /api/v20/process#processemitwarningwarning-options
[filtering tests by name]: /api/v20/test#filtering-tests-by-name
[jitless]: https://v8.dev/blog/jitless
[libuv threadpool documentation]: https://docs.libuv.org/en/latest/threadpool.html
[remote code execution]: https://www.owasp.org/index.php/Code_Injection
[running tests from the command line]: /api/v20/test#running-tests-from-the-command-line
[scavenge garbage collector]: https://v8.dev/blog/orinoco-parallel-scavenger
[security warning]: #warning-binding-inspector-to-a-public-ipport-combination-is-insecure
[semi-space]: https://www.memorymanagement.org/glossary/s.html#semi.space
[single executable application]: single-executable-applications.md
[test reporters]: /api/v20/test#test-reporters
