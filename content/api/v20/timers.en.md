...
<Metadata version="v20.3.1" data={{"source_link":"lib/timers.js"}} />
...
* Returns: [`Immediate`](/api/v20/timers#immediate) a reference to `immediate`
...
* Returns: [`Timeout`](/api/v20/timers#timeout) a reference to `timeout`
...
* Returns: [`Immediate`](/api/v20/timers#immediate) for use with [`clearImmediate()`][]
...
* `delay` [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) The number of milliseconds to wait before calling the
  `callback`. **Default:** `1`.
* `...args` [`any`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Data_types) Optional arguments to pass when the `callback` is called.
* Returns: [`Timeout`](/api/v20/timers#timeout) for use with [`clearInterval()`][]
...
* `delay` [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) The number of milliseconds to wait before calling the
  `callback`. **Default:** `1`.
* `...args` [`any`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Data_types) Optional arguments to pass when the `callback` is called.
* Returns: [`Timeout`](/api/v20/timers#timeout) for use with [`clearTimeout()`][]
...
* `immediate` [`Immediate`](/api/v20/timers#immediate) An `Immediate` object as returned by
  [`setImmediate()`][].
...
* `timeout` [`Timeout`](/api/v20/timers#timeout) | [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) A `Timeout` object as returned by [`setInterval()`][]
...
* `timeout` [`Timeout`](/api/v20/timers#timeout) | [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) A `Timeout` object as returned by [`setTimeout()`][]
  or the [primitive][] of the `Timeout` object as a string or a number.
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `ref` [`boolean`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type) Set to `false` to indicate that the scheduled `Timeout`
    ...
    **Default:** `true`.
  * `signal` [`AbortSignal`](/api/v20/globals#abortsignal) An optional `AbortSignal` that can be used to
...
[`AbortController`]: /api/v20/globals#class-abortcontroller
