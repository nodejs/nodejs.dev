...
<Metadata version="v20.3.1" data={{"source_link":"lib/http2.js"}} />
...
* `session` [`Http2Session`](/api/v20/http2#http2session)
...
* `opaqueData` [`Buffer`](/api/v20/buffer#buffer) If additional opaque data was included in the `GOAWAY`
...
* `payload` [`Buffer`](/api/v20/buffer#buffer) The `PING` frame 8-byte payload
...
* `stream` [`Http2Stream`](/api/v20/http2#http2stream) A reference to the stream
...
* `opaqueData` [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) A `TypedArray` or `DataView`
...
* `payload` [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) Optional ping payload.
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
...
* [`net.Socket`](/api/v20/net#netsocket) | [`tls.TLSSocket`](/api/v20/tls#tlstlssocket)
...
* Extends: [`Http2Session`](/api/v20/http2#http2session)
...
* `alt` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) A description of the alternative service configuration as
  defined by [RFC 7838][].
* `originOrStream` [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) | [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`URL`](/api/v20/url#the-whatwg-url-api) | [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) Either a URL string specifying
...
* Returns: [`ClientHttp2Stream`](/api/v20/http2#clienthttp2stream)
...
* [`Http2Session`](/api/v20/http2#http2session)
...
* Extends [`Http2Stream`](/api/v20/http2#http2stream)
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) Callback that is called once the push stream has been
  ...
  * `pushStream` [`ServerHttp2Stream`](/api/v20/http2#serverhttp2stream) The returned `pushStream` object.
...
* `fd` [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) | [`FileHandle`](/api/v20/fs#filehandle) A readable file descriptor.
* `headers` {HTTP/2 Headers Object}
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
...
* `request` [`http2.Http2ServerRequest`](/api/v20/http2#http2http2serverrequest)
* `response` [`http2.Http2ServerResponse`](/api/v20/http2#http2http2serverresponse)
...
* `session` [`ServerHttp2Session`](/api/v20/http2#serverhttp2session)
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
* Returns: [`Http2Server`](/api/v20/http2#http2server)
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
* Returns: [`Http2SecureServer`](/api/v20/http2#http2secureserver)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  * `Http1IncomingMessage` [`http.IncomingMessage`](/api/v20/http#httpincomingmessage) Specifies the
  ...
  * `Http1ServerResponse` [`http.ServerResponse`](/api/v20/http#httpserverresponse) Specifies the `ServerResponse`
    class to used for HTTP/1 fallback. Useful for extending the original
    `http.ServerResponse`. **Default:** `http.ServerResponse`.
  * `Http2ServerRequest` [`http2.Http2ServerRequest`](/api/v20/http2#http2http2serverrequest) Specifies the
    `Http2ServerRequest` class to use.
    Useful for extending the original `Http2ServerRequest`.
    **Default:** `Http2ServerRequest`.
  * `Http2ServerResponse` [`http2.Http2ServerResponse`](/api/v20/http2#http2http2serverresponse) Specifies the
...
* `authority` [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) | [`URL`](/api/v20/url#the-whatwg-url-api) The remote HTTP/2 server to connect to. This must
...
* `listener` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) Will be registered as a one-time listener of the
  [`'connect'`][] event.
* Returns: [`ClientHttp2Session`](/api/v20/http2#clienthttp2session)
...
* `buf` [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) The packed settings.
* Returns: {HTTP/2 Settings Object}
...
* `msecs` [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type)
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
* Returns: [`http2.Http2ServerRequest`](/api/v20/http2#http2http2serverrequest)
...
* [`Http2Stream`](/api/v20/http2#http2stream)
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) Called once `http2stream.pushStream()` is finished,
  ...
  * `err` [`Error`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)
  * `res` [`http2.Http2ServerResponse`](/api/v20/http2#http2http2serverresponse) The newly-created `Http2ServerResponse`
    object
...
* [`http2.Http2ServerRequest`](/api/v20/http2#http2http2serverrequest)
...
* `msecs` [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type)
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
* Returns: [`http2.Http2ServerResponse`](/api/v20/http2#http2http2serverresponse)
...
[`net.Socket.bufferSize`]: /api/v20/net#socketbuffersize
[`net.Socket.prototype.ref()`]: /api/v20/net#socketref
[`net.Socket.prototype.unref()`]: /api/v20/net#socketunref
[`net.Socket`]: /api/v20/net#class-netsocket
[`net.connect()`]: /api/v20/net#netconnect
[`net.createServer()`]: /api/v20/net#netcreateserveroptions-connectionlistener
[`request.authority`]: #requestauthority
[`request.maxHeadersCount`]: /api/v20/http#requestmaxheaderscount
...
[`response.write(data, encoding)`]: /api/v20/http#responsewritechunk-encoding-callback
[`response.writeContinue()`]: #responsewritecontinue
[`response.writeHead()`]: #responsewriteheadstatuscode-statusmessage-headers
[`server.maxHeadersCount`]: /api/v20/http#servermaxheaderscount
[`tls.Server.close()`]: /api/v20/tls#serverclosecallback
...
[`writable.writableFinished`]: /api/v20/stream#writablewritablefinished
