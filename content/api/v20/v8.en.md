...
<Metadata version="v20.3.1" data={{"source_link":"lib/v8.js"}} />
...
### <DataTag tag="M" /> `v8.getHeapSnapshot([options])`

<Metadata data={{"changes":[{"version":"v19.1.0","pr-url":"https://github.com/nodejs/node/pull/44989","description":"Support options to configure the heap snapshot."}],"update":{"type":"added","version":["v11.13.0"]}}} />
...
* Returns: [`stream.Readable`](/api/v20/stream#streamreadable) A Readable containing the V8 heap snapshot.
...
### <DataTag tag="M" /> `v8.writeHeapSnapshot([filename[,options]])`
...
* `buffer` [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) A buffer returned by [`serialize()`][].
...
* `buffer` [`Buffer`](/api/v20/buffer#buffer) | [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) | [`DataView`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) A buffer returned by
...
[`--heapsnapshot-near-heap-limit`]: /api/v20/cli#--heapsnapshot-near-heap-limitmax_count
[`AsyncLocalStorage`]: async_context.md#class-asynclocalstorage
[`Buffer`]: /api/v20/buffer
[`DefaultDeserializer`]: #class-v8defaultdeserializer
[`DefaultSerializer`]: #class-v8defaultserializer
[`Deserializer`]: #class-v8deserializer
[`ERR_BUFFER_TOO_LARGE`]: /api/v20/errors#err_buffer_too_large
...
[`buffer.constants.MAX_LENGTH`]: /api/v20/buffer#bufferconstantsmax_length
...
[`vm.Script`]: /api/v20/vm#new-vmscriptcode-options
