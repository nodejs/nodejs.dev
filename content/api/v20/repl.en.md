...
<Metadata version="v20.3.1" data={{"source_link":"lib/repl.js"}} />
...
* Extends: [`readline.Interface`](/api/v20/readline#readlineinterface)
...
* `callback` [`Function`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) called when history writes are ready or upon error
  ...
  * `repl` [`repl.REPLServer`](/api/v20/repl#replserver)
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) | [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type)
  ...
  * `input` [`stream.Readable`](/api/v20/stream#streamreadable) The `Readable` stream from which REPL input will
    be read. **Default:** `process.stdin`.
  * `output` [`stream.Writable`](/api/v20/stream#streamwritable) The `Writable` stream to which REPL output will
...
* Returns: [`repl.REPLServer`](/api/v20/repl#replserver)
...
[TTY keybindings]: /api/v20/readline#tty-keybindings
[ZSH]: https://en.wikipedia.org/wiki/Z_shell
[`'uncaughtException'`]: /api/v20/process#event-uncaughtexception
[`--no-experimental-repl-await`]: /api/v20/cli#--no-experimental-repl-await
[`ERR_DOMAIN_CANNOT_SET_UNCAUGHT_EXCEPTION_CAPTURE`]: /api/v20/errors#err_domain_cannot_set_uncaught_exception_capture
[`ERR_INVALID_REPL_INPUT`]: /api/v20/errors#err_invalid_repl_input
...
[`readline.InterfaceCompleter`]: /api/v20/readline#use-of-the-completer-function
