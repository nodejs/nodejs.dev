...
#### <DataTag tag="M" /> `ERR_ACCESS_DENIED`
...
#### <DataTag tag="M" /> `ERR_HTTP_BODY_NOT_ALLOWED`
...
#### <DataTag tag="M" /> `ERR_HTTP_SOCKET_ASSIGNED`
...
#### <DataTag tag="M" /> `ERR_NOT_SUPPORTED_IN_SNAPSHOT`
...
#### <DataTag tag="M" /> `ERR_SOCKET_CONNECTION_TIMEOUT`
...
<Metadata data={{"update":{"type":"added","version":["v18.1.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v12.5.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v12.12.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v10.0.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v11.0.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v15.0.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v14.0.0"]}}} />
...
<Metadata data={{"changes":[{"version":"v10.12.0","pr-url":"https://github.com/nodejs/node/pull/23053","description":"Rather than emitting an error, `process.stderr.end()` now only closes the stream side but not the underlying resource, making this error obsolete."}],"update":{"type":"removed","version":["v10.12.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v11.7.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v18.1.0","v16.17.0"]}}} />
...
<Metadata data={{"update":{"type":"removed","version":["v16.9.0"]}}} />
...
[ES Module]: /api/v20/esm
[ICU]: /api/v20/intl#internationalization-support
[JSON Web Key Elliptic Curve Registry]: https://www.iana.org/assignments/jose/jose.xhtml#web-key-elliptic-curve
[JSON Web Key Types Registry]: https://www.iana.org/assignments/jose/jose.xhtml#web-key-types
[Node.js error codes]: #nodejs-error-codes
[Permission Model]: /api/v20/permissions#permission-model
[RFC 7230 Section 3]: https://tools.ietf.org/html/rfc7230#section-3
[Subresource Integrity specification]: https://www.w3.org/TR/SRI/#the-integrity-attribute
[V8's stack trace API]: https://v8.dev/docs/stack-trace-api
[WHATWG Supported Encodings]: /api/v20/util#whatwg-supported-encodings
[WHATWG URL API]: /api/v20/url#the-whatwg-url-api
[`"exports"`]: /api/v20/packages#exports
[`"imports"`]: /api/v20/packages#imports
[`'uncaughtException'`]: /api/v20/process#event-uncaughtexception
[`--disable-proto=throw`]: /api/v20/cli#--disable-protomode
[`--force-fips`]: /api/v20/cli#--force-fips
[`--no-addons`]: /api/v20/cli#--no-addons
[`Class: assert.AssertionError`]: /api/v20/assert#class-assertassertionerror
...
[`REPL`]: /api/v20/repl
[`ServerResponse`]: /api/v20/http#class-httpserverresponse
[`Writable`]: /api/v20/stream#class-streamwritable
[`child_process`]: child_process.md
[`cipher.getAuthTag()`]: /api/v20/crypto#ciphergetauthtag
[`crypto.getDiffieHellman()`]: /api/v20/crypto#cryptogetdiffiehellmangroupname
[`crypto.scrypt()`]: /api/v20/crypto#cryptoscryptpassword-salt-keylen-options-callback
[`crypto.scryptSync()`]: /api/v20/crypto#cryptoscryptsyncpassword-salt-keylen-options
[`crypto.timingSafeEqual()`]: /api/v20/crypto#cryptotimingsafeequala-b
[`dgram.connect()`]: /api/v20/dgram#socketconnectport-address-callback
[`dgram.createSocket()`]: /api/v20/dgram#dgramcreatesocketoptions-callback
[`dgram.disconnect()`]: /api/v20/dgram#socketdisconnect
[`dgram.remoteAddress()`]: /api/v20/dgram#socketremoteaddress
[`errno`(3) man page]: https://man7.org/linux/man-pages/man3/errno.3.html
[`fs.Dir`]: /api/v20/fs#class-fsdir
[`fs.cp()`]: /api/v20/fs#fscpsrc-dest-options-callback
[`fs.readFileSync`]: /api/v20/fs#fsreadfilesyncpath-options
[`fs.readdir`]: /api/v20/fs#fsreaddirpath-options-callback
[`fs.symlink()`]: /api/v20/fs#fssymlinktarget-path-type-callback
[`fs.symlinkSync()`]: /api/v20/fs#fssymlinksynctarget-path-type
[`fs.unlink`]: /api/v20/fs#fsunlinkpath-callback
[`fs`]: /api/v20/fs
[`hash.digest()`]: /api/v20/crypto#hashdigestencoding
[`hash.update()`]: /api/v20/crypto#hashupdatedata-inputencoding
[`http`]: /api/v20/http
[`https`]: /api/v20/https
[`libuv Error handling`]: https://docs.libuv.org/en/v1.x/errors.html
[`net.Socket.write()`]: /api/v20/net#socketwritedata-encoding-callback
[`net`]: /api/v20/net
[`new URL(input)`]: /api/v20/url#new-urlinput-base
[`new URLSearchParams(iterable)`]: /api/v20/url#new-urlsearchparamsiterable
[`package.json`]: /api/v20/packages#nodejs-packagejson-field-definitions
[`postMessage()`]: worker_threads.md#portpostmessagevalue-transferlist
[`process.on('exit')`]: /api/v20/process#event-exit
[`process.send()`]: /api/v20/process#processsendmessage-sendhandle-options-callback
[`process.setUncaughtExceptionCaptureCallback()`]: /api/v20/process#processsetuncaughtexceptioncapturecallbackfn
[`readable._read()`]: /api/v20/stream#readable_readsize
[`require('node:crypto').setEngine()`]: /api/v20/crypto#cryptosetengineengine-flags
[`require()`]: /api/v20/modules#requireid
[`server.close()`]: /api/v20/net#serverclosecallback
[`server.listen()`]: /api/v20/net#serverlisten
[`sign.sign()`]: /api/v20/crypto#signsignprivatekey-outputencoding
[`stream.pipe()`]: /api/v20/stream#readablepipedestination-options
[`stream.push()`]: /api/v20/stream#readablepushchunk-encoding
[`stream.unshift()`]: /api/v20/stream#readableunshiftchunk-encoding
[`stream.write()`]: /api/v20/stream#writablewritechunk-encoding-callback
...
[`util.getSystemErrorName(error.errno)`]: /api/v20/util#utilgetsystemerrornameerr
[`util.inspect()`]: /api/v20/util#utilinspectobject-options
[`util.parseArgs()`]: /api/v20/util#utilparseargsconfig
[`v8.startupSnapshot.setDeserializeMainFunction()`]: v8.md#v8startupsnapshotsetdeserializemainfunctioncallback-data
[`zlib`]: /api/v20/zlib
[crypto digest algorithm]: /api/v20/crypto#cryptogethashes
[debugger]: /api/v20/debugger
[define a custom subpath]: /api/v20/packages#subpath-exports
[domains]: /api/v20/domain
[event emitter-based]: /api/v20/events#class-eventemitter
[file descriptors]: https://en.wikipedia.org/wiki/File_descriptor
[policy]: /api/v20/permissions#policies
[self-reference a package using its name]: /api/v20/packages#self-referencing-a-package-using-its-name
[stream-based]: /api/v20/stream
