...
<Metadata version="v20.3.1" data={{"source_link":"lib/assert.js"}} />
...
<Metadata data={{"changes":[{"version":"v20.1.0","pr-url":"https://github.com/nodejs/node/pull/47740","description":"the `assert.CallTracker` class has been deprecated and will be removed in a future version."}],"update":{"type":"added","version":["v14.2.0","v12.19.0"]}}} />
