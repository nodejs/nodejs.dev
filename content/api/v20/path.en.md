...
<Metadata version="v20.3.1" data={{"source_link":"lib/path.js"}} />
...
<Metadata data={{"changes":[{"version":"v6.0.0","pr-url":"https://github.com/nodejs/node/pull/5348","description":"Passing a non-string as the `path` argument will throw now."}],"update":{"type":"added","version":["v0.1.25"]}}} />
...
<Metadata data={{"changes":[{"version":"v6.0.0","pr-url":"https://github.com/nodejs/node/pull/5348","description":"Passing a non-string as the `path` argument will throw now."}],"update":{"type":"added","version":["v0.1.16"]}}} />
...
<Metadata data={{"changes":[{"version":"v19.0.0","pr-url":"https://github.com/nodejs/node/pull/44349","description":"The dot will be added if it is not specified in `ext`."}],"update":{"type":"added","version":["v0.11.15"]}}} />
...
<Metadata data={{"update":{"type":"added","version":["v0.1.23"]}}} />
...
<Metadata data={{"changes":[{"version":"v15.3.0","pr-url":"https://github.com/nodejs/node/pull/34962","description":"Exposed as `require('path/posix')`."}],"update":{"type":"added","version":["v0.11.15"]}}} />
...
<Metadata data={{"changes":[{"version":"v6.8.0","pr-url":"https://github.com/nodejs/node/pull/8523","description":"On Windows, the leading slashes for UNC paths are now included in the return value."}],"update":{"type":"added","version":["v0.5.0"]}}} />
...
<Metadata data={{"changes":[{"version":"v15.3.0","pr-url":"https://github.com/nodejs/node/pull/34962","description":"Exposed as `require('path/win32')`."}],"update":{"type":"added","version":["v0.11.15"]}}} />
