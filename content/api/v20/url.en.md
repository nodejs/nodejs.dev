...
<Metadata version="v20.3.1" data={{"source_link":"lib/url.js"}} />
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/47339","description":"ICU requirement is removed."}]}} />
...
* [`URLSearchParams`](/api/v20/url#urlsearchparams)
...
* `blob` [`Blob`](/api/v20/buffer#blob)
* Returns: [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type)

Creates a `'blob:nodedata:...'` URL string that represents the given [`Blob`](/api/v20/buffer#blob)
...
The data stored by the registered [`Blob`](/api/v20/buffer#blob) will be retained in memory until
...
Removes the stored [`Blob`](/api/v20/buffer#blob) identified by the given ID. Attempting to revoke a
ID that isn't registered will silently fail.

##### <DataTag tag="M" /> `URL.canParse(input[, base])`
...
##### <DataTag tag="M" /> `urlSearchParams.delete(name[, value])`

<Metadata data={{"changes":[{"version":"v20.2.0","pr-url":"https://github.com/nodejs/node/pull/47885","description":"Add support for optional `value` argument."}]}} />
...
##### <DataTag tag="M" /> `urlSearchParams.has(name[, value])`
...
<Metadata data={{"changes":[{"version":"v20.0.0","pr-url":"https://github.com/nodejs/node/pull/47339","description":"ICU requirement is removed."}],"update":{"type":"added","version":["v7.4.0","v6.13.0"]}}} />
...
* `url` [`URL`](/api/v20/url#the-whatwg-url-api) | [`string`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) The file URL string or URL object to convert to a path.
...
* `URL` [`URL`](/api/v20/url#the-whatwg-url-api) A [WHATWG URL][] object
...
* Returns: [`URL`](/api/v20/url#the-whatwg-url-api) The file URL object.
...
<Metadata data={{"changes":[{"version":"v19.9.0","pr-url":"https://github.com/nodejs/node/pull/46989","description":"The returned object will also contain all the own enumerable properties of the `url` argument."}],"update":{"type":"added","version":["v15.7.0","v14.18.0"]}}} />

* `url` [`URL`](/api/v20/url#the-whatwg-url-api) The [WHATWG URL][] object to convert to an options object.
...
[`querystring`]: /api/v20/querystring
