...
<Metadata version="v20.3.1" data={{"source_link":"lib/dns.js"}} />
...
### <DataTag tag="M" /> `dns.getDefaultResultOrder()`
...
#### <DataTag tag="M" /> `dnsPromises.getDefaultResultOrder()`
...
[`--dns-result-order`]: /api/v20/cli#--dns-result-orderorder
