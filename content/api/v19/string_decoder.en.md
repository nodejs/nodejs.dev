...
<Metadata version="v19.3.0" data={{"source_link":"lib/string_decoder.js"}} />
...
<Metadata version="v19.3.0" data={{"changes":[{"version":"v8.0.0","pr-url":"https://github.com/nodejs/node/pull/9618","description":"Each invalid character is now replaced by a single replacement character instead of one for each individual byte."}],"update":{"type":"added","version":["v0.1.99"]}}} />
