...
<Metadata version="v19.6.0" data={{"update":{"type":"introduced_in","version":["v12.19.0"]}}} />
...
<Metadata version="v19.6.0" data={{"changes":[{"version":"v15.0.0","pr-url":"https://github.com/nodejs/node/pull/35597","description":"The `CommonEnvironmentSetup` and `SpinEventLoop` utilities were added."}]}} />
...
[CLI options]: /api/v19/cli
[`process.memoryUsage()`]: /api/v19/process#processmemoryusage
[deprecation policy]: /api/v19/deprecations
