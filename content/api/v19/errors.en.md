...
<Metadata version="v19.2.0" data={{"update":{"type":"introduced_in","version":["v4.0.0"]}}} />
...
<Metadata version="v19.2.0" data={{"type":"class"}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v16.9.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v15.0.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v12.5.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v16.4.0","v14.17.4"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v14.0.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v15.14.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v17.1.0","v16.14.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v18.6.0","v16.17.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v13.3.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"added","version":["v18.1.0"]}}} />
...
<Metadata version="v19.2.0" data={{"changes":[{"version":["v11.4.0","v10.15.0"],"commit":"186035243fad247e3955f","pr-url":"https://github.com/nodejs-private/node-private/pull/143","description":"Max header size in `http_parser` was set to 8 KiB."}]}} />
...
<Metadata version="v19.2.0" data={{"changes":[{"version":"v12.0.0","pr-url":"https://github.com/nodejs/node/pull/25690","description":"Added `requireStack` property."}]}} />
...
<Metadata version="v19.2.0" data={{"stability":{"level":0,"text":" - Deprecated. These error codes are either inconsistent, or have been removed."}}} />

<a id="ERR_CANNOT_TRANSFER_OBJECT"></a>

#### <DataTag tag="M" /> `ERR_CANNOT_TRANSFER_OBJECT`

<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v12.5.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v12.12.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v10.0.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v11.0.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v15.0.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v14.0.0"]}}} />
...
<Metadata version="v19.2.0" data={{"changes":[{"version":"v10.12.0","pr-url":"https://github.com/nodejs/node/pull/23053","description":"Rather than emitting an error, `process.stderr.end()` now only closes the stream side but not the underlying resource, making this error obsolete."}],"update":{"type":"removed","version":["v10.12.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v11.7.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v18.1.0","v16.17.0"]}}} />
...
<Metadata version="v19.2.0" data={{"update":{"type":"removed","version":["v16.9.0"]}}} />
...
[ES Module]: /api/v19/esm
[ICU]: /api/v19/intl#internationalization-support
...
[WHATWG Supported Encodings]: /api/v19/util#whatwg-supported-encodings
[WHATWG URL API]: /api/v19/url#the-whatwg-url-api
[`"exports"`]: /api/v19/packages#exports
[`"imports"`]: /api/v19/packages#imports
[`'uncaughtException'`]: /api/v19/process#event-uncaughtexception
[`--disable-proto=throw`]: /api/v19/cli#--disable-protomode
[`--force-fips`]: /api/v19/cli#--force-fips
[`--no-addons`]: /api/v19/cli#--no-addons
[`Class: assert.AssertionError`]: /api/v19/assert#class-assertassertionerror
...
[`REPL`]: /api/v19/repl
[`Writable`]: /api/v19/stream#class-streamwritable
[`child_process`]: child_process.md
[`cipher.getAuthTag()`]: /api/v19/crypto#ciphergetauthtag
[`crypto.getDiffieHellman()`]: /api/v19/crypto#cryptogetdiffiehellmangroupname
[`crypto.scrypt()`]: /api/v19/crypto#cryptoscryptpassword-salt-keylen-options-callback
[`crypto.scryptSync()`]: /api/v19/crypto#cryptoscryptsyncpassword-salt-keylen-options
[`crypto.timingSafeEqual()`]: /api/v19/crypto#cryptotimingsafeequala-b
[`dgram.connect()`]: /api/v19/dgram#socketconnectport-address-callback
[`dgram.createSocket()`]: /api/v19/dgram#dgramcreatesocketoptions-callback
[`dgram.disconnect()`]: /api/v19/dgram#socketdisconnect
[`dgram.remoteAddress()`]: /api/v19/dgram#socketremoteaddress
[`errno`(3) man page]: https://man7.org/linux/man-pages/man3/errno.3.html
[`fs.Dir`]: /api/v19/fs#class-fsdir
[`fs.cp()`]: /api/v19/fs#fscpsrc-dest-options-callback
[`fs.readFileSync`]: /api/v19/fs#fsreadfilesyncpath-options
[`fs.readdir`]: /api/v19/fs#fsreaddirpath-options-callback
[`fs.symlink()`]: /api/v19/fs#fssymlinktarget-path-type-callback
[`fs.symlinkSync()`]: /api/v19/fs#fssymlinksynctarget-path-type
[`fs.unlink`]: /api/v19/fs#fsunlinkpath-callback
[`fs`]: /api/v19/fs
[`hash.digest()`]: /api/v19/crypto#hashdigestencoding
[`hash.update()`]: /api/v19/crypto#hashupdatedata-inputencoding
[`http`]: /api/v19/http
[`https`]: /api/v19/https
...
[`package.json`]: /api/v19/packages#nodejs-packagejson-field-definitions
[`postMessage()`]: worker_threads.md#portpostmessagevalue-transferlist
[`process.on('exit')`]: /api/v19/process#event-exit
...
[`readable._read()`]: /api/v19/stream#readable_readsize
[`require('node:crypto').setEngine()`]: /api/v19/crypto#cryptosetengineengine-flags
[`require()`]: /api/v19/modules#requireid
[`server.close()`]: /api/v19/net#serverclosecallback
[`server.listen()`]: /api/v19/net#serverlisten
[`sign.sign()`]: /api/v19/crypto#signsignprivatekey-outputencoding
[`stream.pipe()`]: /api/v19/stream#readablepipedestination-options
[`stream.push()`]: /api/v19/stream#readablepushchunk-encoding
[`stream.unshift()`]: /api/v19/stream#readableunshiftchunk-encoding
[`stream.write()`]: /api/v19/stream#writablewritechunk-encoding-callback
...
[`util.getSystemErrorName(error.errno)`]: /api/v19/util#utilgetsystemerrornameerr
[`util.inspect()`]: /api/v19/util#utilinspectobject-options
[`util.parseArgs()`]: /api/v19/util#utilparseargsconfig
[`v8.startupSnapshot.setDeserializeMainFunction()`]: v8.md#v8startupsnapshotsetdeserializemainfunctioncallback-data
[`zlib`]: /api/v19/zlib
[crypto digest algorithm]: /api/v19/crypto#cryptogethashes
[debugger]: /api/v19/debugger
[define a custom subpath]: /api/v19/packages#subpath-exports
[domains]: /api/v19/domain
[event emitter-based]: /api/v19/events#class-eventemitter
[file descriptors]: https://en.wikipedia.org/wiki/File_descriptor
[policy]: /api/v19/permissions#policies
[self-reference a package using its name]: /api/v19/packages#self-referencing-a-package-using-its-name
[stream-based]: /api/v19/stream
