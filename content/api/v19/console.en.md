...
<Metadata version="v19.8.1" data={{"source_link":"lib/console.js"}} />
...
* `options` [`Object`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  * `stdout` [`stream.Writable`](/api/v19/stream#streamwritable)
  * `stderr` [`stream.Writable`](/api/v19/stream#streamwritable)
