...
<Metadata version="v19.4.0" data={{"changes":[{"version":"v15.0.0","pr-url":"https://github.com/nodejs/node/pull/34682","description":"Throw ERR_INVALID_ARG_VALUE instead of ERR_INVALID_OPT_VALUE for invalid input arguments."}],"update":{"type":"added","version":["v5.12.0"]}}} />
...
<Metadata version="v19.4.0" data={{"update":{"type":"added","version":["v5.3.0"]}}} />
...
<Metadata version="v19.4.0" data={{"changes":[{"version":["v14.10.0","v12.19.0"],"pr-url":"https://github.com/nodejs/node/pull/34960","description":"This function is also available as `buf.readBigUint64LE()`."}],"update":{"type":"added","version":["v12.0.0","v10.20.0"]}}} />
...
<Metadata version="v19.4.0" data={{"stability":{"level":0,"text":" - Deprecated: Use `buf.subarray` instead."}}} />
...
<Metadata version="v19.4.0" data={{"changes":[{"version":["v14.10.0","v12.19.0"],"pr-url":"https://github.com/nodejs/node/pull/34960","description":"This function is also available as `buf.writeBigUint64BE()`."}],"update":{"type":"added","version":["v12.0.0","v10.20.0"]}}} />
...
<Metadata version="v19.4.0" data={{"changes":[{"version":["v14.10.0","v12.19.0"],"pr-url":"https://github.com/nodejs/node/pull/34960","description":"This function is also available as `buf.writeBigUint64LE()`."}],"update":{"type":"added","version":["v12.0.0","v10.20.0"]}}} />
...
<Metadata version="v19.4.0" data={{"stability":{"level":0,"text":" - Deprecated: Use `Buffer.from(array)` instead."}}} />
...
<Metadata version="v19.4.0" data={{"stability":{"level":0,"text":" - Deprecated: Use `Buffer.from(buffer)` instead."}}} />
...
<Metadata version="v19.4.0" data={{"stability":{"level":0,"text":" - Deprecated: Use `Buffer.alloc()`][] instead (also see [`Buffer.allocUnsafe()`)."}}} />
...
<Metadata version="v19.4.0" data={{"stability":{"level":0,"text":" - Deprecated: Use [`Buffer.from(string[, encoding])`][`Buffer.from(string)`] instead."}}} />
...
<Metadata version="v19.4.0" data={{"update":{"type":"added","version":["v19.2.0"]}}} />
...
<Metadata version="v19.4.0" data={{"stability":{"level":3,"text":" - Legacy. Use `Buffer.from(data, 'base64')` instead."}}} />
...
<Metadata version="v19.4.0" data={{"stability":{"level":3,"text":" - Legacy. Use `buf.toString('base64')` instead."}}} />
...
<Metadata version="v19.4.0" data={{"changes":[{"version":"v8.0.0","pr-url":"https://github.com/nodejs/node/pull/10236","description":"The `source` parameter can now be a `Uint8Array`."}],"update":{"type":"added","version":["v7.1.0"]}}} />
...
<Metadata version="v19.4.0" data={{"stability":{"level":0,"text":" - Deprecated: Use `Buffer.allocUnsafeSlow()` instead."}}} />
