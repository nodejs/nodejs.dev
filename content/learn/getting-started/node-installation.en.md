...
Official packages for all the major platforms are available at [https://nodejs.dev/en/download/](https://nodejs.dev/en/download/).

One very convenient way to install Node.js is through a package manager. In this case, every operating system has its own.

Other package managers for MacOS, Linux, and Windows are listed in [https://nodejs.dev/en/download/package-manager/](https://nodejs.dev/en/download/package-manager/)
