...
export default connectGraphQlArticle(ArticleLayout, {
  editPath: 'content/get-involved/code-learn.md',
  sidenavKey: SideNavBarKeys.codeLearn,
});

export const query = graphql`
  query ($locale: String!, $defaultLocale: String!) {
    articleCurrentLanguage: mdx(
      fields: { slug: { eq: "code-learn" }, locale: { eq: $locale } }
    ) {
      body
      tableOfContents
      frontmatter {
    ...
    articleDefaultLanguage: mdx(
      fields: { slug: { eq: "code-learn" }, locale: { eq: $defaultLocale } }
    ) {
      body
      tableOfContents
      frontmatter {
