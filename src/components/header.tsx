...
const Header = ({ darkModeController }: Props): JSX.Element => (
  <nav className="nav">
    <div className="logo">
      <Link to="/">
        <img src={logoLight} alt="Node.js" className="nav__logo light-mode-only" />
        <img src={logoDark} alt="Node.js" className="nav__logo dark-mode-only" />
      </Link>
    </div>
    ...
    <ul className="right-container">
      <li className="nav__tabs nav__tabs--right">
        <button
          ...
          onClick={(): void => {
            if (!darkModeController) document.body.classList.toggle('dark-mode');
          }}
          onPointerDown={(): void => {
      ...
      <li className="nav__tabs">
        <a target="_blank" href="https://github.com/nodejs/nodejs.dev" rel="noopener noreferrer">
          <span className="sr-only">GitHub</span>
          <svg width="2.4rem" height="2.4rem" viewBox="0 0 438.549 438.549" style={{ fill: 'var(--color-text-accent)' }}>
