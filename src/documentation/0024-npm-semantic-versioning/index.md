...
* `^`: if you write `^0.13.0`, when running `npm update` it can update to patch releases: `0.13.1`, `0.13.2` and so on(previous to 1.0.0, it only updates patch versions). If you write `^1.13.0`, when running `npm update` it can update to patch and minor releases: `1.13.1`, `1.14.0` and so on.
